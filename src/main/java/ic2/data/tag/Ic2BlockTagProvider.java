...
{
	private static final Set<Block> unconnectableBlockList = Set.of(Ic2Blocks.NUKE, Ic2Blocks.ITNT, Ic2Blocks.ITEM_BUFFER, Ic2Blocks.OBSCURED_WALL, Ic2Blocks.IRON_FURNACE);
	...
	protected @NotNull IntrinsicTagAppender<Block> tag(@NotNull TagKey<Block> tag)
	{
	...
	protected void addTags(HolderLookup.@NotNull Provider lookupProvider)
	{
		...
		this.tag(Ic2BlockTags.RUBBER_LOGS).add(Ic2Blocks.RUBBER_LOG).add(Ic2Blocks.RUBBER_WOOD).add(Ic2Blocks.STRIPPED_RUBBER_LOG).add(Ic2Blocks.STRIPPED_RUBBER_WOOD);
	...
	{
		String identifierPath = ForgeRegistries.BLOCKS.getKey(block).getPath();
