...
public class BlastFurnaceRecipeProvider extends Ic2RecipeProvider
{
	...
	protected void generate(Consumer<FinishedRecipe> consumer)
	{
		...
		gen.fluidDuration(1, 6000).add(Items.f_41834_, 1, new ItemStack(Ic2Items.STEEL_INGOT), new ItemStack(Ic2Items.SLAG));
		...
		gen.fluidDuration(1, 6000).add(Items.f_42416_, 1, new ItemStack(Ic2Items.STEEL_INGOT), new ItemStack(Ic2Items.SLAG));
	}
}
