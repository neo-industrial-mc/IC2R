...
public class ShapedRecipeProvider extends Ic2RecipeProvider
{
	...
	protected void generate(Consumer<FinishedRecipe> consumer)
	{
		...
		gen.start(Ic2Items.REACTOR_VESSEL, 4, "PSP", "SPS", "PSP").key('P', Ic2ItemTags.LEAD_PLATES).key('S', Items.f_41905_).finish("reactor_vessel");
		gen.start(Ic2Items.REACTOR_ACCESS_HATCH, "VVV", "VHV", "VVV")
			.key('V', Ic2Items.REACTOR_VESSEL)
			.key('H', ItemTags.f_13144_)
		...
		gen.start(Ic2Items.REINFORCED_GLASS, 7, "GAG", "GGG", "GAG").key('G', Items.f_41904_).key('A', Ic2Items.ALLOY).finish("reinforced_glass");
		gen.start(Ic2Items.REINFORCED_GLASS, 7, "GGG", "AGA", "GGG").key('G', Items.f_41904_).key('A', Ic2Items.ALLOY).finish("reinforced_glass_2");
		gen.start(Ic2Items.CROP_STICK, 2, "S S", "S S").key('S', Items.f_42398_).finish("crop_stick");
		gen.start(Ic2Items.BATBOX, "PCP", "BBB", "PPP")
			.key('P', ItemTags.f_13168_)
		...
		gen.start(Ic2Items.WIND_GENERATOR, "I I", " G ", "I I").key('I', Items.f_42416_).key('G', Ic2Items.GENERATOR).finish("wind_generator");
		...
		gen.start(Ic2Items.STIRLING_KINETIC_GENERATOR, "GPG", "GMG", "GPG")
			.key('G', Items.f_42590_)
			.key('P', Items.f_41869_)
			.key('M', Ic2Items.MACHINE)
			.finish("stirling_kinetic_generator");
		gen.start(Ic2Items.ITNT, 4, "FFF", "TTT", "FFF").key('F', Items.f_42484_).key('T', Items.f_41996_).finish("itnt");
		gen.start(Ic2Items.ITNT, 4, "FTF", "FTF", "FTF").key('F', Items.f_42484_).key('T', Items.f_41996_).finish("itnt_vertical");
		...
		gen.start(Ic2Items.SOLID_CANNER, " T ", " T ", "CMC")
			...
			.key('C', Ic2Items.CIRCUIT)
			.finish("solid_canner");
		gen.start(Ic2Items.IRON_FURNACE, " I ", "I I", "IFI").key('I', Ic2ItemTags.IRON_PLATES).key('F', Items.f_41962_).finish("iron_furnace");
		...
		gen.start(Ic2Items.RECYCLER, " G ", "DMD", "IDI")
			.key('D', Items.f_42329_)
			.key('G', Items.f_42525_)
			.key('M', Ic2Items.COMPRESSOR)
			.key('I', Items.f_42416_)
			.finish("recycler");
		...
		gen.start(Ic2Items.MACERATOR, "FFF", "SMS", " C ")
			.key('F', Items.f_42484_)
			.key('S', Items.f_42594_)
			.key('M', Ic2Items.MACHINE)
			.key('C', Ic2Items.CIRCUIT)
			.finish("macerator");
		...
		gen.start(Ic2Items.COMPRESSOR, "S S", "SMS", "SCS").key('S', Items.f_41905_).key('M', Ic2Items.MACHINE).key('C', Ic2Items.CIRCUIT).finish("compressor");
		...
		gen.start(Ic2Items.WOOL_SHEET, "WRW").key('W', ItemTags.f_215867_).key('R', Ic2Items.RESIN_SHEET).finish("wool_sheet");
		gen.start(Ic2Items.WOODEN_SCAFFOLD, 4, "PPP", " s ", "s s").key('P', ItemTags.f_13168_).key('s', Items.f_42398_).finish("wooden_scaffold");
		...
		gen.start(Ic2Items.ALLOY_CHESTPLATE, "A A", "ALA", "AIA")
			.key('L', Items.f_42408_)
			.key('I', Items.f_42469_)
			.key('A', Ic2Items.ALLOY)
		...
		gen.start(Ic2Items.HAZMAT_CHESTPLATE, "R R", "ROR", "ROR").key('R', Ic2Items.RUBBER).key('O', Items.f_42536_).finish("hazmat_chestplate");
		gen.start(Ic2Items.HAZMAT_HELMET, " O ", "RGR", "R#R")
			.key('R', Ic2Items.RUBBER)
			.key('G', Items.f_41904_)
			.key('#', Items.f_42025_)
			.key('O', Items.f_42536_)
			.finish("hazmat_helmet");
		gen.start(Ic2Items.HAZMAT_LEGGINGS, "ROR", "R R", "R R").key('R', Ic2Items.RUBBER).key('O', Items.f_42536_).finish("hazmat_leggings");
		...
		gen.start(Ic2Items.RUBBER_BOOTS, "R R", "R R", "RWR").key('R', Ic2Items.RUBBER).key('W', Items.f_41870_).finish("rubber_boots");
		...
		gen.start(Ic2Items.COAL_FUEL_DUST, 8, "CCC", "CWC", "CCC").key('C', Ic2ItemTags.COAL_DUSTS).key('W', Fluids.f_76193_, 1000).finish("coal_fuel_dust");
		...
		gen.start(Ic2Items.EMPTY_CELL, " C ", "CGC", " C ").key('C', Ic2Items.TIN_CASING).key('G', Items.f_42027_).finish("empty_cell");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', Items.f_42405_).group("plant_ball").finish("plant_ball_1");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', Items.f_41909_).group("plant_ball").finish("plant_ball_2");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', Items.f_41982_).group("plant_ball").finish("plant_ball_3");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', ItemTags.f_13143_).group("plant_ball").finish("plant_ball_4");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', ItemTags.f_13180_).group("plant_ball").finish("plant_ball_5");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', Items.f_42210_).group("plant_ball").finish("plant_ball_6");
		gen.start(Ic2Items.PLANT_BALL, "PPP", "P P", "PPP").key('P', Items.f_42404_).group("plant_ball").finish("plant_ball_7");
		...
		gen.start(Ic2Items.EMPTY_MUG, "SS ", "SSS", "SS ").key('S', Items.f_41905_).finish("empty_mug");
		...
		gen.start(Ic2Items.CF_POWDER, "SAS", "SCS", "SAS")
			.key('A', Items.f_41830_)
			.key('C', Items.f_42461_)
		...
		gen.start(Ic2Items.COAL_BALL, "CCC", "CFC", "CCC").key('C', Ic2ItemTags.COAL_DUSTS).key('F', Items.f_42484_).finish("coal_ball");
		gen.start(Ic2Items.COAL_CHUNK, "###", "#O#", "###")
			.key('#', Ic2Items.COAL_BLOCK)
			.key('O', itemInput(Items.f_41999_, Items.f_41913_, Items.f_41995_))
			.finish("coal_chunk");
		...
		gen.start(Ic2Items.COIL, "CCC", "CXC", "CCC").key('X', Items.f_42416_).key('C', Ic2Items.COPPER_CABLE).finish("coil");
		gen.start(Ic2Items.ELECTRIC_MOTOR, " T ", "CXC", " T ")
			.key('X', Items.f_42416_)
			.key('C', Ic2Items.COIL)
			.key('T', Ic2Items.TIN_CASING)
		...
		gen.start(Ic2Items.WOODEN_ROTOR_BLADE, "PSP", "PSP", "PSP").key('P', ItemTags.f_13168_).key('S', ItemTags.f_13182_).finish("wooden_rotor_blade");
		gen.start(Ic2Items.BRONZE_ROTOR_BLADE, "PSP", "PSP", "PSP")
			.key('P', Ic2ItemTags.BRONZE_PLATES)
			.key('S', Ic2ItemTags.BRONZE_INGOTS)
			.finish("bronze_rotor_blade");
		gen.start(Ic2Items.IRON_ROTOR_BLADE, "PSP", "PSP", "PSP").key('P', Ic2ItemTags.IRON_PLATES).key('S', Items.f_42416_).finish("iron_rotor_blade");
		...
		gen.start(Ic2Items.WOODEN_ROTOR, " A ", "ABA", " A ").key('A', Ic2Items.WOODEN_ROTOR_BLADE).key('B', Items.f_42416_).finish("wooden_rotor");
		...
		gen.start(Ic2Items.BLANK_TFBP, " C ", " A ", "R R")
			...
			.key('R', Items.REDSTONE)
			.finish("blank_tfbp");
		gen.start(Ic2Items.CHILLING_TFBP, " S ", "S#S", " S ").key('#', Ic2Items.BLANK_TFBP).key('S', Items.f_42452_).finish("chilling_tfbp");
		gen.start(Ic2Items.CULTIVATION_TFBP, " S ", "S#S", " S ").key('#', Ic2Items.BLANK_TFBP).key('S', Items.f_42404_).finish("cultivation_tfbp");
		gen.start(Ic2Items.DESERTIFICATION_TFBP, " S ", "S#S", " S ").key('#', Ic2Items.BLANK_TFBP).key('S', Items.f_41830_).finish("desertification_tfbp");
		gen.start(Ic2Items.FLATIFICATION_TFBP, " D ", "D#D", " D ").key('#', Ic2Items.BLANK_TFBP).key('D', Items.f_42329_).finish("flatification_tfbp");
		gen.start(Ic2Items.IRRIGATION_TFBP, " W ", "W#W", " W ").key('#', Ic2Items.BLANK_TFBP).key('W', Items.f_42447_).finish("irrigation_tfbp");
		gen.start(Ic2Items.MUSHROOM_TFBP, "mMm", "M#M", "mMm")
			.key('#', Ic2Items.BLANK_TFBP)
			.key('M', Items.f_41952_)
			.key('m', Items.f_42093_)
			.finish("mushroom_tfbp");
		gen.start(Ic2Items.BRONZE_AXE, "BB", "SB", "S ").key('B', Ic2ItemTags.BRONZE_INGOTS).key('S', Items.f_42398_).finish("bronze_axe");
		gen.start(Ic2Items.BRONZE_HOE, "BB", "S ", "S ").key('B', Ic2ItemTags.BRONZE_INGOTS).key('S', Items.f_42398_).finish("bronze_hoe");
		gen.start(Ic2Items.BRONZE_PICKAXE, "BBB", " S ", " S ").key('B', Ic2ItemTags.BRONZE_INGOTS).key('S', Items.f_42398_).finish("bronze_pickaxe");
		gen.start(Ic2Items.BRONZE_SHOVEL, "B", "S", "S").key('B', Ic2ItemTags.BRONZE_INGOTS).key('S', Items.f_42398_).finish("bronze_shovel");
		gen.start(Ic2Items.BRONZE_SWORD, "B", "B", "S").key('B', Ic2ItemTags.BRONZE_INGOTS).key('S', Items.f_42398_).finish("bronze_sword");
		gen.start(Ic2Items.CUTTER, "A A", " A ", "I I").key('A', Ic2ItemTags.IRON_PLATES).key('I', Items.f_42416_).finish("cutter");
		...
		gen.start(Ic2Items.FORGE_HAMMER, "II ", "ISS", "II ").key('S', Items.f_42398_).key('I', Items.f_42416_).group("forge_hammer").finish("forge_hammer");
		gen.start(Ic2Items.FORGE_HAMMER, " II", "SSI", " II").key('S', Items.f_42398_).key('I', Items.f_42416_).group("forge_hammer").finish("forge_hammer_2");
		...
		gen.start(Ic2Items.TREETAP, " P ", "PPP", "P  ").key('P', ItemTags.f_13168_).finish("treetap");
		...
		gen.start(Items.f_42446_, "T T", " T ").key('T', Ic2ItemTags.TIN_INGOTS).hidden().finish("bucket");
		gen.start(Items.f_42525_, "RGR", "GRG", "RGR").key('R', Items.REDSTONE).key('G', Ic2ItemTags.GOLD_DUSTS).hidden().finish("glowstone_dust");
		gen.start(Items.f_42403_, 3, "RCR", "CRC", "RCR").key('R', Items.REDSTONE).key('C', Ic2ItemTags.COAL_DUSTS).hidden().finish("gunpowder");
		gen.start(Items.f_42416_, 8, "M").key('M', Ic2Items.MACHINE).group("iron_ingot").finish("iron_ingot_from_machine");
		gen.start(Items.f_42416_, 2, "III", "I I", "III").key('I', Ic2Items.COIN).group("iron_ingot").finish("iron_ingot_from_coin");
		gen.start(Items.f_41869_, "TTT", "#X#", "#R#")
			.key('#', Items.f_42594_)
			.key('X', Ic2ItemTags.BRONZE_INGOTS)
			.key('R', Items.REDSTONE)
			.key('T', ItemTags.f_13168_)
			.hidden()
			.finish("piston");
		gen.start(Items.f_41964_, 8, "B B", "BsB", "B B").key('B', Ic2ItemTags.BRONZE_INGOTS).key('s', Items.f_42398_).hidden().finish("rail");
		gen.start(Items.f_42000_, 4, "R", "I").key('I', Items.f_42398_).key('R', Ic2Items.RESIN).hidden().finish("torch");
		gen.start(Ic2Items.WOODEN_STORAGE_BOX, "LPL", "P P", "LPL").key('L', ItemTags.f_13182_).key('P', ItemTags.f_13168_).finish("wooden_storage_box");
		...
		gen.start(Ic2Items.RUBBER_FENCE, 3, "PIP", "PIP").key('P', Ic2Items.RUBBER_PLANKS).key('I', Items.f_42398_).finish("rubber_fence");
		gen.start(Ic2Items.RUBBER_FENCE_GATE, "IPI", "IPI").key('P', Ic2Items.RUBBER_PLANKS).key('I', Items.f_42398_).finish("rubber_fence_gate");
		...
		gen.start(Ic2Items.RUBBER_SIGN, 3, "PPP", "PPP", " I ").key('P', Ic2Items.RUBBER_PLANKS).key('I', Items.f_42398_).finish("rubber_sign");
