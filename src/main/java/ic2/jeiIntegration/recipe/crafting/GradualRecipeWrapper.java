...
public class GradualRecipeWrapper extends BlankRecipeWrapper {
  ...
  public List<ItemStack> getInputs() {
    ...
    ItemStack repairItem = this.recipe.getRecipeOutput();
  ...
  public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
    ...
    String effectiveness = Localization.translate("ic2.jei.condenser", new Object[] { Float.valueOf(Util.limit(this.recipe.amount / this.recipe.item.getMaxCustomDamage(this.recipe.getRecipeOutput()) * 100.0F, 0.0F, 100.0F)) });
    int width = minecraft.fontRenderer.getStringWidth(effectiveness);
    if (143 - width < 55) {
