...
public class GradualRecipeWrapper extends BlankRecipeWrapper {
   ...
   public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
      ...
      String effectiveness = Localization.translate(
         "ic2.jei.condenser", Util.limit((float)this.recipe.amount / this.recipe.item.getMaxCustomDamage(this.recipe.getRecipeOutput()) * 100.0F, 0.0F, 100.0F)
      );
