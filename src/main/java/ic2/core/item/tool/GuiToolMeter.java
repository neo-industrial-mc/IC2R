...
{
    public GuiToolMeter(final ContainerMeter container) {
        super(container, 217);
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 112, 55, 20, 20, this.createModeSetter(ContainerMeter.Mode.EnergyIn))).withTooltip("ic2.itemToolMEter.mode.switch\nic2.itemToolMEter.mode.EnergyIn"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 132, 55, 20, 20, this.createModeSetter(ContainerMeter.Mode.EnergyOut))).withTooltip("ic2.itemToolMEter.mode.switch\nic2.itemToolMEter.mode.EnergyOut"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 112, 75, 20, 20, this.createModeSetter(ContainerMeter.Mode.EnergyGain))).withTooltip("ic2.itemToolMEter.mode.switch\nic2.itemToolMEter.mode.EnergyGain"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 132, 75, 20, 20, this.createModeSetter(ContainerMeter.Mode.Voltage))).withTooltip("ic2.itemToolMEter.mode.switch\nic2.itemToolMEter.mode.Voltage"));
    }
    ...
    protected void drawForegroundLayer(final int mouseX, final int mouseY) {
        ...
        this.fontRenderer.drawString(Localization.translate("ic2.itemToolMEter.cycle", ((ContainerMeter)this.container).getResultCount() / 20), 15, 100, 2157374);
