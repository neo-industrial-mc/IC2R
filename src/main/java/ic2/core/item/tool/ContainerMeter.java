...
public class ContainerMeter extends ContainerHandHeldInventory<HandHeldMeter> {
  ...
  @ClientModifiable private ContainerMeter.Mode mode = ContainerMeter.Mode.EnergyIn;
  ...
  public void broadcastChanges() {
    ...
    if (stats == null) {
      ...
      if (this.resultCount == 0) {
        ...
        this.resultAvg =
            (int) (((long) this.resultAvg * this.resultCount + scaled) / (this.resultCount + 1));
      }

      this.resultCount++;
      IC2.network
          .get(true)
          .sendContainerFields(this, "resultAvg", "resultMin", "resultMax", "resultCount");
    }
  }
