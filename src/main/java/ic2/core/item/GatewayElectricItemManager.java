...
public class GatewayElectricItemManager implements IElectricItemManager {
  ...
  public double charge(
    ...
    return manager == null
        ? 0.0
        : manager.charge(stack, amount, tier, ignoreTransferLimit, simulate);
  }
  ...
  public double discharge(
    ...
    return manager == null
        ? 0.0
        : manager.discharge(stack, amount, tier, ignoreTransferLimit, externally, simulate);
  }
  ...
  private IElectricItemManager getManager(ItemStack stack) {
    ...
    if (item == null) {
      ...
      return item instanceof IElectricItem
          ? ElectricItem.rawManager
          : ElectricItem.getBackupManager(stack);
    }
  }
