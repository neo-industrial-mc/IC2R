...
public class BoatItem extends Item {
  ...
  public BoatItem(
      Class<? extends Boat> boatEntityClass,
      EntityType<? extends Boat> boatEntityType,
      Properties settings) {
    super(settings);
  ...
  private Boat createEntity(Level world, HitResult hitResult) {
    ...
    try {
      Constructor<? extends Boat> constructor =
          this.boatEntityClass.getConstructor(
              EntityType.class, Level.class, double.class, double.class, double.class);
