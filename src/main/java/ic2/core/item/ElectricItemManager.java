...
public class ElectricItemManager implements IElectricItemManager {
      ...
      if (!simulate) {
        ...
        if (stack.getItem() instanceof IElectricItem) {
          ...
          DamageHandler.setDamage(
              stack, mapChargeLevelToDamage(newCharge, item.getMaxCharge(stack), maxDamage), true);
        } else {
  ...
  public double getCharge(ItemStack stack) {
    return ElectricItem.manager.discharge(
        stack, Double.POSITIVE_INFINITY, Integer.MAX_VALUE, true, false, true);
  }
  ...
  public boolean use(ItemStack stack, double amount, LivingEntity entity) {
    ...
    double transfer =
        ElectricItem.manager.discharge(stack, amount, Integer.MAX_VALUE, true, false, true);
  ...
  public String getToolTip(ItemStack stack) {
    ...
    double space =
        ElectricItem.manager.charge(stack, Double.POSITIVE_INFINITY, Integer.MAX_VALUE, true, true);
