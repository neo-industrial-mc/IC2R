...
public class TileEntityGeoGenerator extends TileEntityBaseGenerator {
  ...
  public TileEntityGeoGenerator(BlockPos pos, BlockState state) {
    ...
    this.fluidTank =
        this.fluids.addTankInsert(
            "fluid", 8000, Fluids.fluidPredicate(net.minecraft.world.level.material.Fluids.LAVA));
    this.production =
        Math.round(20.0F * IC2Config.balance.energy.generator.geothermal.get().floatValue());
    this.fluidSlot =
  ...
  protected void onBlockBreak() {
    ...
    if (!this.fluidTank.isEmpty()) {
      LiquidUtil.fillWorldFluidBlock(
          Ic2FluidStack.create(net.minecraft.world.level.material.Fluids.LAVA, 1000),
          this.getLevel(),
          this.worldPosition,
          false);
    }
