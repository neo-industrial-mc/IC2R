...
public class TileEntityWindGenerator extends TileEntityBaseRotorGenerator
  ...
  @GuiSynced private double overheatRatio;
  ...
  public boolean gainEnergy() {
    ...
    if (++this.ticker % 128 == 0) {
      ...
      double wind =
          windSim.getWindAt(this.worldPosition.getY()) * (1.0 - this.obstructedBlockCount / 567.0);
      if (wind <= 0.0) {
        return false;
      }
