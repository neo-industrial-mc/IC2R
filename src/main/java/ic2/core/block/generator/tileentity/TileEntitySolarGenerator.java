...
public class TileEntitySolarGenerator extends TileEntityBaseGenerator {
  ...
  @GuiSynced public boolean sunlight = false;
  ...
  public static float getSkyLight(Level world, BlockPos pos) {
    ...
    float sunBrightness =
        Util.limit((float) Math.cos(world.getSunAngle(1.0F)) * 2.0F + 0.2F, 0.0F, 1.0F);
  ...
  @Override
  public ContainerBase<TileEntitySolarGenerator> createServerScreenHandler(
