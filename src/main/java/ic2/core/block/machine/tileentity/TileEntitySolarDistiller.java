...
@NotClassic
public class TileEntitySolarDistiller extends TileEntityInventory
  ...
  public void updateSunVisibility() {
    this.skyLight =
        TileEntitySolarGenerator.getSkyLight(this.getLevel(), this.worldPosition.above());
  }
