...
public class TileEntityChunkloader extends TileEntityInventory implements INetworkClientTileEntityEventListener, IHasGui, IUpgradableBlock {
  ...
  public TileEntityChunkloader() {
    ...
    this.dischargeSlot = new InvSlotDischarge((IInventorySlotHolder)this, InvSlot.Access.IO, 1, true, InvSlot.InvSide.ANY);
    this.energy = (Energy)addComponent((TileEntityComponent)Energy.asBasicSink((TileEntityBlock)this, 2500.0D, 1).addManagedSlot((InvSlot)this.dischargeSlot));
  }
  ...
  public ContainerBase<TileEntityChunkloader> getGuiContainer(EntityPlayer player) {
    return (ContainerBase<TileEntityChunkloader>)new ContainerChunkLoader(player, this);
  }
