...
public class TileEntityClassicCanner extends TileEntityElectricMachine implements IHasGui, IGuiValueProvider, INetworkTileEntityEventListener
{
	...
	public TileEntityClassicCanner()
	{
		...
		this.inputSlot = new InvSlotConsumableItemStack(this, "canInput", 1, ItemName.crafting.getItemStack((Enum) CraftingItemType.tin_can), ItemName.crafting.getItemStack((Enum) CraftingItemType.empty_fuel_can))
		{
	...
	public void operate(boolean incremental)
	{
		...
		switch (this.mode)
		{
			case FOOD:
				...
				newInput = result.getAdjustedInput();
