...
public class TileEntityBatchCrafter extends TileEntityElectricMachine implements IHasGui, IUpgradableBlock, IGuiValueProvider, INetworkClientTileEntityEventListener
{
	...
	public final InvSlotOutput containerOutput = new InvSlotOutput(this, "containersOut", this.craftingGrid.length, InvSlot.InvSide.NO_SIDE);
	...
	public final Predicate<Tuple.T2<ItemStack, Integer>> acceptPredicate = input -> TileEntityBatchCrafter.this.ingredientsRow[input.b].accepts(input.a);
	...
	protected void craft()
	{
		...
		NonNullList<ItemStack> nonNullList = this.recipe.getRemainingItems(this.ingredients);
		World world = getWorld();
