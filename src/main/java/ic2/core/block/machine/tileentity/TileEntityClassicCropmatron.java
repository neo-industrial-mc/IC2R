...
public class TileEntityClassicCropmatron extends TileEntityElectricMachine implements IHasGui
{
	...
	public TileEntityClassicCropmatron()
	{
		...
		this.scanY = -1;
		this.scanZ = -4;
		this.fertilizerSlot = new InvSlotConsumableItemStack(this, "fertilizer", 3, ItemName.crop_res.getItemStack((Enum) CropResItemType.fertilizer));
		this.hydrationSlot = new InvSlotConsumableItemStack(this, "hydration", 3, ItemName.cell.getItemStack((Enum) CellType.hydration));
		this.weedExSlot = new InvSlotConsumableItemStack(this, "weedEx", 3, ItemName.cell.getItemStack((Enum) CellType.weed_ex));
	}
