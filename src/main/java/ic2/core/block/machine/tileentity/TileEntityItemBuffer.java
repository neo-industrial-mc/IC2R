...
public class TileEntityItemBuffer extends TileEntityInventory implements IHasGui, IUpgradableBlock {
  ...
  public TileEntityItemBuffer(BlockPos pos, BlockState state) {
    ...
    this.rightcontentSlot =
        new InvSlot(this, "rightcontent", InvSlot.Access.IO, 24, InvSlot.InvSide.SIDE);
    this.leftcontentSlot =
        new InvSlot(this, "leftcontent", InvSlot.Access.IO, 24, InvSlot.InvSide.NOTSIDE);
    this.upgradeSlot = new InvSlotUpgrade(this, "upgrade", 2);
    this.comparator.setUpdate(
        () -> calcRedstoneFromInvSlots(this.rightcontentSlot, this.leftcontentSlot));
  }
