...
public class TileEntityClassicElectrolyzer extends TileEntityInventory implements IHasGui
{
	...
	public TileEntityClassicElectrolyzer()
	{
		...
		this.waterSlot = new InvSlotConsumableItemStack(this, "water", InvSlot.Access.IO, 1, InvSlot.InvSide.TOP, ItemName.cell.getItemStack((Enum) CellType.water));
		this.hydrogenSlot = new InvSlotConsumableItemStack(this, "hydrogen", InvSlot.Access.IO, 1, InvSlot.InvSide.BOTTOM, ItemName.cell.getItemStack((Enum) CellType.electrolyzed_water));
		this.energy = (Energy) addComponent((TileEntityComponent) new Energy(this, 20000.0D, Util.noFacings, Util.noFacings, 1));
	...
	{
		return DynamicContainer.create((IInventory) this, player, GuiParser.parse(this.teBlock));
	}
