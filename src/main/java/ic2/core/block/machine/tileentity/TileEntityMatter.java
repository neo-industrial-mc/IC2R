...
public class TileEntityMatter extends TileEntityElectricMachine
  ...
  public final InvSlotProcessable<IRecipeInput, Integer, ItemStack> amplifierSlot =
      new InvSlotProcessable<>(this, "scrap", 1, Recipes.matterFabricator) {
  ...
  public TileEntityMatter(BlockPos pos, BlockState state) {
    super(
        Ic2BlockEntities.MATTER_GENERATOR,
        pos,
        state,
        Math.round(1000000.0F * IC2Config.balance.uuEnergyFactor.get().floatValue()),
        getDefaultTier());
    ...
    this.fluidTank =
        this.fluids.addTank("fluidTank", 8000, Fluids.fluidPredicate(Ic2Fluids.UU_MATTER.still()));
