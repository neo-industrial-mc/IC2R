...
public class GuiAdvMiner extends GuiIC2<ContainerAdvMiner> {
  ...
  protected void drawForegroundLayer(int mouseX, int mouseY) {
    ...
    if (target != null) {
      ...
      this.fontRenderer.drawString(Localization.translate("ic2.AdvMiner.gui.info.minelevel", new Object[] { Integer.valueOf(target.getX() - pos.getX()), Integer.valueOf(target.getZ() - pos.getZ()), Integer.valueOf(target.getY() - pos.getY()) }), 28, 105, 2157374);
    } 
