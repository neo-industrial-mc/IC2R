...
public class GuiSortingMachine extends Ic2Gui<ContainerSortingMachine> {
  private static final ResourceLocation texture =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guisortingmachine.png");

  public GuiSortingMachine(
      ContainerSortingMachine container, Inventory playerInventory, Component title) {
    ...
    for (Direction dir : Util.ALL_DIRS) {
      ...
      this.addElement(
          Image.create(
              ...
              256,
              256,
              new FixedSizeOverlaySupplier(18) {
                @Override
                public int getUS() {
                  return 212;
                }
      ...
      this.addElement(
          new CustomButton(
                  ...
                  texture,
                  this.createEventSender(dir.ordinal()))
              .withTooltip(
                  (Supplier<String>)
                      () ->
                          container.base.defaultRoute != cDir
                              ? "ic2.SortingMachine.whitelist"
                              : "ic2.SortingMachine.default"));
    }
  }
