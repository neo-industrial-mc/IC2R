...
public class GuiSolarDestiller extends Ic2Gui<ContainerSolarDistiller> {
  public GuiSolarDestiller(
      ContainerSolarDistiller container, Inventory playerInventory, Component title) {
  ...
  protected void renderBg(GuiGraphics guiGraphics, float delta, int mouseX, int mouseY) {
    ...
    if (((ContainerSolarDistiller) this.menu).base.canWork()) {
      this.drawTexturedRect(
          guiGraphics.pose(), this.leftPos + 36, this.topPos + 26, 0.0, 184.0, 97.0, 29.0);
    }
  }
