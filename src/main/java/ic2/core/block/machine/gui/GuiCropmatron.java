...
public class GuiCropmatron extends GuiIC2<ContainerCropmatron>
{
	...
	{
		super(container, 192);
		addElement(EnergyGauge.asBolt(this, 138, 82, container.base));
		addElement(TankGauge.createPlain(this, 11, 26, 24, 47, container.base.getWaterTank()));
		addElement(TankGauge.createPlain(this, 105, 26, 24, 47, container.base.getExTank()));
	}
