...
public class GuiReplicator extends GuiIC2<ContainerReplicator>
{
    public GuiReplicator(final ContainerReplicator container) {
        ...
        this.addElement(((GuiElement<GuiElement<?>>)new ItemImage(this, 91, 17, (Supplier<ItemStack>)new Supplier<ItemStack>() {
        ...
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 80, 16, 9, 18, this.createEventSender(0))).withTooltip("ic2.Replicator.gui.info.last"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 109, 16, 9, 18, this.createEventSender(1))).withTooltip("ic2.Replicator.gui.info.next"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 75, 82, 16, 16, this.createEventSender(3))).withTooltip("ic2.Replicator.gui.info.Stop"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 92, 82, 16, 16, this.createEventSender(4))).withTooltip("ic2.Replicator.gui.info.single"));
        this.addElement(((GuiElement<GuiElement<?>>)new CustomButton(this, 109, 82, 16, 16, this.createEventSender(5))).withTooltip("ic2.Replicator.gui.info.repeat"));
