...
public class GuiElectrolyzer extends Ic2Gui<ContainerElectrolyzer> {
  private static final ResourceLocation background =
      IC2.getIdentifier("textures/gui/guielectrolyzer.png");

  public GuiElectrolyzer(
      ContainerElectrolyzer container, Inventory playerInventory, Component title) {
    ...
    for (GuiElectrolyzer.ElectrolyzerGauges gauge : GuiElectrolyzer.ElectrolyzerGauges.values()) {
      ...
      last =
          new CustomGauge(this, 36 + gauge.offset, 36, container.base, gauge.properties)
              .withEnableHandler(() -> tanks[id].isActive());
  ...
  public enum ElectrolyzerGauges {
    ONE_TANK(
        new Gauge.GaugePropertyBuilder(
                57, 232, 12, 23, Gauge.GaugePropertyBuilder.GaugeOrientation.Down)
            .build(),
        48),
    TWO_TANK(
        new Gauge.GaugePropertyBuilder(
                1, 232, 54, 23, Gauge.GaugePropertyBuilder.GaugeOrientation.Down)
            .build(),
        24),
    THREE_TANK(
        new Gauge.GaugePropertyBuilder(
                41, 159, 54, 23, Gauge.GaugePropertyBuilder.GaugeOrientation.Down)
            .build(),
        24),
    FOUR_TANK(
        new Gauge.GaugePropertyBuilder(
                1, 208, 96, 23, Gauge.GaugePropertyBuilder.GaugeOrientation.Down)
            .build(),
        3),
    FIVE_TANK(
        new Gauge.GaugePropertyBuilder(
                1, 184, 96, 23, Gauge.GaugePropertyBuilder.GaugeOrientation.Down)
            .build(),
        3);
