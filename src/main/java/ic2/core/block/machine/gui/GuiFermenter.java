...
public class GuiFermenter extends Ic2Gui<ContainerFermenter> {
  private static final ResourceLocation TEXTURE =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guifermenter.png");
  ...
  public GuiFermenter(ContainerFermenter container, Inventory playerInventory, Component title) {
    ...
    this.addElement(
        new LinkedGauge(this, 42, 41, container.base, "heat", Gauge.GaugeStyle.HeatFermenter)
            .withTooltip(
                (Supplier<String>)
                    () ->
                        Component.translatable("ic2.Fermenter.gui.info.conversion")
                            + " "
                            + (int) (container.base.getGuiValue("heat") * 100.0)
                            + "%"));
    this.addElement(
        new LinkedGauge(
                this, 38, 88, container.base, "progress", Gauge.GaugeStyle.ProgressFermenter)
