...
public class GuiCondenser extends Ic2Gui<ContainerCondenser> {
  private static final ResourceLocation BACKGROUND =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guicondenser.png");
  ...
  public GuiCondenser(ContainerCondenser container, Inventory playerInventory, Component title) {
    ...
    Supplier<String> ventTooltipSupplier =
        () -> Component.translatable("ic2.Condenser.gui.tooltipvent", (short) 2).getString();
    this.addElement(
        new SlotGrid(this, 25, 25, 1, 2, SlotGrid.SlotStyle.Normal)
            .withTooltip(ventTooltipSupplier));
    this.addElement(
        new SlotGrid(this, 133, 25, 1, 2, SlotGrid.SlotStyle.Normal)
            .withTooltip(ventTooltipSupplier));
    ...
    this.addElement(
        new LinkedGauge(
            this, 47, 63, container.base, "progress", Gauge.GaugeStyle.ProgressCondenser));
  }
