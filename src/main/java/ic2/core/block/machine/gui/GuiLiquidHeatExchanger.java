...
public class GuiLiquidHeatExchanger extends Ic2Gui<ContainerLiquidHeatExchanger>
{
	public GuiLiquidHeatExchanger(ContainerLiquidHeatExchanger container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 20, 28, 138, 13, TextProvider.of(() -> Component.translatable("ic2.ElectricHeatGenerator.gui.hUmax", GuiLiquidHeatExchanger.this.menu.base.gettransmitHeat(), GuiLiquidHeatExchanger.this.menu.base.getMaxHeatEmittedPerTick()).getString()), 5752026, false, true, true).withTooltip("ic2.LiquidHeatExchanger.gui.tooltipheat"));
	}
