...
public class GuiSteamGenerator extends Ic2Gui<ContainerSteamGenerator>
{
	...
	public GuiSteamGenerator(ContainerSteamGenerator container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 66, 25, 81, 13, TextProvider.of(() -> GuiSteamGenerator.this.menu.base.getOutputMB() + Component.translatable("ic2.generic.text.mb").getString() + Component.translatable("ic2.generic.text.tick").getString()), 2157374, false, 4, 0, false, true).withTooltip("ic2.steam_generator.gui.info.fluidoutput"));
