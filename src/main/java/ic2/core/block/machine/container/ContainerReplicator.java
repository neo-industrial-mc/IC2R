...
public class ContainerReplicator extends ContainerElectricMachine<TileEntityReplicator>
{
	public ContainerReplicator(EntityPlayer player, TileEntityReplicator tileEntity1)
	{
		...
		addSlotToContainer(new SlotInvSlot(tileEntity1.outputSlot, 0, 90, 59));
		addSlotToContainer(new SlotInvSlot(tileEntity1.fluidSlot, 0, 8, 27));
		addSlotToContainer(new SlotInvSlot(tileEntity1.cellSlot, 0, 8, 72));
		for (int i = 0; i < 4; i++)
