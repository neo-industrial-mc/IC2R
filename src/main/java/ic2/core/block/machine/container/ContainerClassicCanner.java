...
public class ContainerClassicCanner extends ContainerElectricMachine<TileEntityClassicCanner>
{
	public ContainerClassicCanner(EntityPlayer player, TileEntityClassicCanner base)
	{
		...
		this.addSlotToContainer(new SlotInvSlot(base.resInputSlot, 0, 69, 17));
		this.addSlotToContainer(new SlotInvSlot(base.outputSlot, 0, 119, 35));
		this.addSlotToContainer(new SlotInvSlot(base.inputSlot, 0, 69, 53));
	}
