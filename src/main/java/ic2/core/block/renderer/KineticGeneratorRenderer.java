...
public class KineticGeneratorRenderer<T extends BlockEntity & IRotorProvider>
  ...
  public void render(
    ...
    if (diameter != 0) {
      ...
      float angle =
          (windGen.getAngle() + windGen.getRotorAnimationSpeed() * DEGREES_PER_TICK * partial)
              % 360.0F;
      ...
      if (model == null) {
        ...
        modelPartData.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(0.0F, 0.0F, -4.0F, 1.0F, diameter * 8, 8.0F),
      ...
      light =
          LevelRenderer.getLightColor(windGen.getLevel(), windGen.getBlockPos().relative(facing));
      model.render(
          matrices, vertexConsumers.getBuffer(RenderType.entitySolid(rotorRL)), light, overlay);
      matrices.popPose();
    }
  }
}
