...
public class TileEntityWindKineticGenerator extends TileEntityInventory implements IKineticSource, IRotorProvider, IHasGui {
  ...
  public final InvSlotConsumableClass rotorSlot = (InvSlotConsumableClass)new InvSlotConsumableKineticRotor((IInventorySlotHolder)this, "rotorslot", InvSlot.Access.IO, 1, InvSlot.InvSide.ANY, IKineticRotor.GearboxType.WIND, "rotorSlot");
  ...
  public ContainerBase<TileEntityWindKineticGenerator> getGuiContainer(EntityPlayer player) {
    return (ContainerBase<TileEntityWindKineticGenerator>)new ContainerWindKineticGenerator(player, this);
  }
  ...
  public String getRotorHealth() {
    if (!this.rotorSlot.isEmpty())
      return Localization.translate("ic2.WindKineticGenerator.gui.rotorhealth", new Object[] { Integer.valueOf((int)(100.0F - this.rotorSlot.get().func_77952_i() / this.rotorSlot.get().func_77958_k() * 100.0F)) }); 
    return "";
  }
  ...
  public int getConnectionBandwidth(EnumFacing side) {
    return facingMatchesDirection(side.func_176734_d()) ? getKuOutput() : 0;
  }
  ...
  public int drawKineticEnergy(EnumFacing side, int request, boolean simulate) {
    if (facingMatchesDirection(side.func_176734_d()))
  ...
  public void setActive(boolean active) {
    if (active != getActive())
      ((NetworkManager)IC2.network.get(true)).updateTileEntityField((TileEntity)this, "rotorSlot"); 
