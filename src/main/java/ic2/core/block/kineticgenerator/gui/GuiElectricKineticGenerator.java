...
public class GuiElectricKineticGenerator extends Ic2Gui<ContainerElectricKineticGenerator> {
  private static final ResourceLocation background =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guielectrickineticgenerator.png");

  public GuiElectricKineticGenerator(
      ContainerElectricKineticGenerator container, Inventory playerInventory, Component title) {
                ...
                TextProvider.of(
                    () ->
                        Component.translatable(
                                ...
                                GuiElectricKineticGenerator.this.menu.base.getMaxKU(),
                                GuiElectricKineticGenerator.this.menu.base.getMaxKUForGUI())
                            .getString()),
                5752026,
                false,
                true,
