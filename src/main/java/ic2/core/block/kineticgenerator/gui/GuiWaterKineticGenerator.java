...
public class GuiWaterKineticGenerator extends GuiIC2<ContainerWaterKineticGenerator>
{
	public GuiWaterKineticGenerator(ContainerWaterKineticGenerator container)
	{
		...
		addElement(Text.create(this, 27, 52, TextProvider.ofTranslated("ic2.WaterKineticGenerator.gui.rotormiss"), 2157374, false).withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, missingRotor)));
		...
		addElement(Text.create(this, 55, 52, TextProvider.of(() -> Localization.translate("ic2.WaterKineticGenerator.gui.output", container.base.getKuOutput())), 2157374, false)
			.withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, hasRotor, hasRotorSpace)));
		addElement(Text.create(this, 46, 70, TextProvider.of(container.base::getRotorHealth), 2157374, false).withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, hasRotor, hasRotorSpace)));
	}
