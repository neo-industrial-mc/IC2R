...
public class GuiWaterKineticGenerator extends Ic2Gui<ContainerWaterKineticGenerator>
{
	...
	public GuiWaterKineticGenerator(ContainerWaterKineticGenerator container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 38, 52, TextProvider.ofTranslated("ic2.WaterKineticGenerator.gui.wrongbiome1"), 2157374, false).withEnableHandler(invalidBiome));
		this.addElement(TextLabel.create(this, 45, 69, TextProvider.ofTranslated("ic2.WaterKineticGenerator.gui.wrongbiome2"), 2157374, false).withEnableHandler(invalidBiome));
		IEnableHandler missingRotor = container.base.rotorSlot::isEmpty;
		this.addElement(TextLabel.create(this, 27, 52, TextProvider.ofTranslated("ic2.WaterKineticGenerator.gui.rotormiss"), 2157374, false).withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, missingRotor)));
		...
		this.addElement(TextLabel.create(this, 20, 52, TextProvider.ofTranslated("ic2.WaterKineticGenerator.gui.rotorspace"), 2157374, false).withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, hasRotor, IEnableHandler.EnableHandlers.not(hasRotorSpace))));
		this.addElement(TextLabel.create(this, 55, 52, TextProvider.of(() -> Component.translatable("ic2.WaterKineticGenerator.gui.output", container.base.getKuOutput()).getString()), 2157374, false).withEnableHandler(IEnableHandler.EnableHandlers.and(validBiome, hasRotor, hasRotorSpace)));
