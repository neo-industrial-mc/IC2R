...
public class RenderBeam extends Render<EntityParticle> {
  ...
  public void doRender(EntityParticle entity, double x, double y, double z, float yaw, float partialTickTime) {
    ...
    double playerX = ((EntityPlayer)entityPlayerSP).field_70169_q + (((EntityPlayer)entityPlayerSP).field_70165_t - ((EntityPlayer)entityPlayerSP).field_70169_q) * partialTickTime;
    double playerY = ((EntityPlayer)entityPlayerSP).field_70167_r + (((EntityPlayer)entityPlayerSP).field_70163_u - ((EntityPlayer)entityPlayerSP).field_70167_r) * partialTickTime;
    double playerZ = ((EntityPlayer)entityPlayerSP).field_70166_s + (((EntityPlayer)entityPlayerSP).field_70161_v - ((EntityPlayer)entityPlayerSP).field_70166_s) * partialTickTime;
    double particleX = particle.field_70169_q + (particle.field_70165_t - particle.field_70169_q) * partialTickTime - playerX;
    double particleY = particle.field_70167_r + (particle.field_70163_u - particle.field_70167_r) * partialTickTime - playerY;
    double particleZ = particle.field_70166_s + (particle.field_70161_v - particle.field_70166_s) * partialTickTime - playerZ;
    double u1 = 0.0D;
    double u2 = 1.0D;
    double v1 = 0.0D;
    double v2 = 1.0D;
