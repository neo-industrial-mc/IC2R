...
public class GuiEnergyOMatClosed extends Ic2Gui<ContainerEnergyOMatClosed> {
  private static final ResourceLocation background =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guienergyomatclosed.png");

  public GuiEnergyOMatClosed(
      ContainerEnergyOMatClosed container, Inventory playerInventory, Component title) {
  ...
  protected void drawForegroundLayer(GuiGraphics guiGraphics, int mouseX, int mouseY) {
    ...
    this.drawString(
        ...
        12,
        57,
        Component.translatable("ic2.container.personalTraderEnergy.paidFor", this.menu.base.paidFor)
            .getString(),
        4210752);
  }
