...
public class GuiTradeOMatClosed extends Ic2Gui<ContainerTradeOMatClosed>
{
	...
	protected void drawForegroundLayer(GuiGraphics guiGraphics, int mouseX, int mouseY)
	{
		...
		this.drawString(guiGraphics, 12, 42, Localization.translate("ic2.container.personalTrader.offer"), 4210752);
		this.drawString(guiGraphics, 12, 60, Localization.translate("ic2.container.personalTrader.stock"), 4210752);
		this.drawString(
			guiGraphics,
			50,
			60,
