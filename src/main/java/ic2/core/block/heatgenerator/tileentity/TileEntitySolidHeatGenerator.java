...
@NotClassic
public class TileEntitySolidHeatGenerator extends TileEntityHeatSourceInventory
    implements IHasGui, IGuiValueProvider {
  public static final int emittedHU =
      Math.round(20.0F * (float) IC2Config.balance.energy.heatGenerator.solid.get().floatValue());
  ...
  @GuiSynced public int itemFuelTime = 0;
