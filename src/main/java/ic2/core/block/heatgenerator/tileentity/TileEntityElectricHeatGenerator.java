...
@NotClassic
public class TileEntityElectricHeatGenerator extends TileEntityHeatSourceInventory
    implements IHasGui {
  public static final double outputMultiplier =
      IC2Config.balance.energy.heatGenerator.electric.get();
  public final InvSlotDischarge dischargeSlot;
  public final InvSlotConsumable coilSlot =
      new InvSlotConsumableItemStack(this, "CoilSlot", 10, new ItemStack(Ic2Items.COIL));
  ...
  @Override
  public ContainerBase<TileEntityElectricHeatGenerator> createServerScreenHandler(
