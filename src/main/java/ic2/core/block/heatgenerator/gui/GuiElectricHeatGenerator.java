...
public class GuiElectricHeatGenerator extends Ic2Gui<ContainerElectricHeatGenerator>
{
	...
	public GuiElectricHeatGenerator(ContainerElectricHeatGenerator container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 34, 66, 109, 13, TextProvider.of(() -> Component.translatable("ic2.ElectricHeatGenerator.gui.hUmax", GuiElectricHeatGenerator.this.menu.base.gettransmitHeat(), GuiElectricHeatGenerator.this.menu.base.getMaxHeatEmittedPerTick()).getString()), 5752026, false, true, true).withTooltip("ic2.ElectricHeatGenerator.gui.tooltipheat"));
	}
