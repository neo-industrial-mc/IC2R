...
public class GuiElectricHeatGenerator extends Ic2Gui<ContainerElectricHeatGenerator> {
  private static final ResourceLocation background =
      ResourceLocation.fromNamespaceAndPath("ic2", "textures/gui/guielectricheatgenerator.png");

  public GuiElectricHeatGenerator(
      ContainerElectricHeatGenerator container, Inventory playerInventory, Component title) {
    super(container, playerInventory, title);
    this.addElement(
        new SlotGrid(this, 43, 26, 5, 2, SlotGrid.SlotStyle.Normal)
                ...
                TextProvider.of(
                    () ->
                        Component.translatable(
                                ...
                                GuiElectricHeatGenerator.this.menu.base.gettransmitHeat(),
                                GuiElectricHeatGenerator.this.menu.base.getMaxHeatEmittedPerTick())
                            .getString()),
                5752026,
                false,
                true,
