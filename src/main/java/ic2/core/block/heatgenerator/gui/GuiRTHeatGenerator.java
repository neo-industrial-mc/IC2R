...
public class GuiRTHeatGenerator extends Ic2Gui<ContainerRTHeatGenerator>
{
	...
	public GuiRTHeatGenerator(ContainerRTHeatGenerator container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 49, 66, 79, 13, TextProvider.of(() -> container.base.gettransmitHeat() + " / " + container.base.getMaxHeatEmittedPerTick()), 5752026, false, 0, 0, true, true).withTooltip("ic2.RTHeatGenerator.gui.tooltipheat"));
	}
