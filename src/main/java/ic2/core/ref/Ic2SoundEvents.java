...
public class Ic2SoundEvents {
  ...
  public static final SoundEvent GENERATOR_NUCLEAR_LOW_POWER =
      register("generator.nuclear.power.low");
  public static final SoundEvent GENERATOR_NUCLEAR_MEDIUM_POWER =
      register("generator.nuclear.power.medium");
  public static final SoundEvent GENERATOR_NUCLEAR_HIGH_POWER =
      register("generator.nuclear.power.high");
  ...
  public static final SoundEvent MACHINE_COMPRESSOR_OPERATE =
      register("machine.compressor.operate");
  ...
  public static final SoundEvent MACHINE_MATTER_GENERATOR_LOOP =
      register("machine.matter_generator.loop");
  public static final SoundEvent MACHINE_MATTER_GENERATOR_SCRAP =
      register("machine.matter_generator.scrap");
  public static final SoundEvent MACHINE_FURNACE_ELECTRIC_START =
      register("machine.furnace.electric.start");
  public static final SoundEvent MACHINE_FURNACE_ELECTRIC_STOP =
      register("machine.furnace.electric.stop");
  public static final SoundEvent MACHINE_FURNACE_ELECTRIC_LOOP =
      register("machine.furnace.electric.loop");
  public static final SoundEvent MACHINE_FURNACE_INDUCTION_START =
      register("machine.furnace.induction.start");
  public static final SoundEvent MACHINE_FURNACE_INDUCTION_STOP =
      register("machine.furnace.induction.stop");
  public static final SoundEvent MACHINE_FURNACE_INDUCTION_LOOP =
      register("machine.furnace.induction.loop");
  public static final SoundEvent MACHINE_FURNACE_IRON_OPERATE =
      register("machine.furnace.iron.operate");
