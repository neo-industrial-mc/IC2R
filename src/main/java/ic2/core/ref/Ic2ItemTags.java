...
public final class Ic2ItemTags {
  ...
  public static final TagKey<Item> URANIUM_raw_materials =
      createResource("uranium", "raw_materials");
  ...
  private static TagKey<Item> create(String fabricName, String forgeName) {
    ResourceLocation id =
        ResourceLocation.parse(IC2.envProxy.isFabricEnv() ? fabricName : toCommon(forgeName));
