...
public class Ic2Crops extends Crops {
  ...
  public static CropCard cropBlazereed =
      GenericCropCard.create(Ic2CropType.blazereed, Ic2Blocks.BLAZEREED_CROP)
          ...
          .setSpecialDrops(
              new ItemStack[] {new ItemStack(Items.BLAZE_ROD), new ItemStack(Ic2Items.SULFUR_DUST)})
          .setAfterHarvestSize(1);
  public static CropCard cropBobsYerUncleRanksBerries =
      GenericCropCard.create(
              Ic2CropType.bobsYerUncleRanksBerries, Ic2Blocks.BOBS_YER_UNCLE_RANKS_BERRIES_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropCorium =
      GenericCropCard.create(Ic2CropType.corium, Ic2Blocks.CORIUM_CROP)
  ...
  public static CropCard cropCorpsePlant =
      GenericCropCard.create(Ic2CropType.corpse_plant, Ic2Blocks.CORPSE_PLANT_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropCreeperWeed =
      GenericCropCard.create(Ic2CropType.creeper_weed, Ic2Blocks.CREEPER_WEED_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropDiareed =
      GenericCropCard.create(Ic2CropType.diareed, Ic2Blocks.DIAREED_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropEggPlant =
      GenericCropCard.create(Ic2CropType.egg_plant, Ic2Blocks.EGG_PLANT_CROP)
  ...
  public static CropCard cropEnderBlossom =
      GenericCropCard.create(Ic2CropType.ender_blossom, Ic2Blocks.ENDER_BLOSSOM_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropMeatRose =
      GenericCropCard.create(Ic2CropType.meat_rose, Ic2Blocks.MEAT_ROSE_CROP)
          ...
          .setGrowthSpeed(1500)
          .setAfterHarvestSize(1);
  public static CropCard cropMilkWart =
      GenericCropCard.create(Ic2CropType.milk_wart, Ic2Blocks.MILK_WART_CROP)
          .setDiscoveredBy("Mr. Brain")
  ...
  public static CropCard cropOilBerries =
      GenericCropCard.create(Ic2CropType.oil_berries, Ic2Blocks.OIL_BERRIES_CROP)
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropSlimePlant =
      GenericCropCard.create(Ic2CropType.slime_plant, Ic2Blocks.SLIME_PLANT_CROP)
          ...
          .setAfterHarvestSize(2);
  public static CropCard cropSpidernip =
      GenericCropCard.create(Ic2CropType.spidernip, Ic2Blocks.SPIDERNIP_CROP)
          .setDiscoveredBy("Mr. Kenny")
          ...
          .setSpecialDrops(
              new ItemStack[] {new ItemStack(Items.SPIDER_EYE), new ItemStack(Blocks.COBWEB)})
          .setGrowthSpeed(600)
          .setAfterHarvestSize(1);
  public static CropCard cropTearstalks =
      GenericCropCard.create(Ic2CropType.tearstalks, Ic2Blocks.TEARSTALKS_CROP)
          .setDiscoveredBy("Neowulf")
          ...
          .setAfterHarvestSize(1);
  public static CropCard cropWithereed =
      GenericCropCard.create(Ic2CropType.withereed, Ic2Blocks.WITHEREED_CROP)
  ...
  public static void registerBaseSeeds() {
    ...
    Crops.instance.registerBaseSeed(
        new ItemStack(Items.DANDELION, 4), cropYellowFlower, 3, 1, 1, 1);
    ...
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.BROWN_MUSHROOM, 4), cropBrownMushroom, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.RED_MUSHROOM, 4), cropRedMushroom, 0, 1, 1, 1);
    ...
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.SPRUCE_SAPLING), cropSpruceSapling, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.BIRCH_SAPLING), cropBirchSapling, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.JUNGLE_SAPLING), cropJungleSapling, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.ACACIA_SAPLING), cropAcaciaSapling, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
        new ItemStack(Blocks.DARK_OAK_SAPLING), cropDarkOakSapling, 0, 1, 1, 1);
    Crops.instance.registerBaseSeed(
  ...
  public CropCard getCropCard(ItemStack stack) {
    ...
    if (stack.is(ItemTags.SAPLINGS) && identifier.getNamespace().equals("minecraft")) {
      ...
      if (nbt == null) {
        ...
        return nbt.contains("owner") && nbt.contains("id")
            ? this.getCropCard(nbt.getString("owner"), nbt.getString("id"))
            : null;
      }
    }
  }
      ...
      public @NotNull Iterator<CropCard> iterator() {
        return new Iterator<>() {
          private final Iterator<Map<String, CropCard>> mapIterator =
              Ic2Crops.this.cropMap.values().iterator();
  ...
  public void registerCrop(CropCard crop) {
    ...
    if (!owner.equals(owner.toLowerCase(Locale.ENGLISH))) {
      throw new IllegalArgumentException(
          "The crop owner=" + owner + " id=" + id + " uses a non-lower case owner");
    }
    ...
    if (prev != null) {
      throw new IllegalArgumentException(
          "The crop owner=" + owner + " id=" + id + " uses a non-unique owner+id pair");
    }
  }

  @Override
  public void registerBaseSeed(
      ItemStack stack, CropCard crop, int size, int growth, int gain, int resistance) {
