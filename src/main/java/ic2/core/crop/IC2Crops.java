...
public class IC2Crops extends Crops
{
	...
	public static CropCard cropRedMushroom = (CropCard) new CropBaseMushroom("red_mushroom", new String[] { "Red", "Food", "Mushroom" }, new ItemStack((Block) Blocks.RED_MUSHROOM));

	public static CropCard cropBrownMushroom = (CropCard) new CropBaseMushroom("brown_mushroom", new String[] { "Brown", "Food", "Mushroom" }, new ItemStack((Block) Blocks.BROWN_MUSHROOM));
	...
	public static CropCard cropOakSapling = (CropCard) new CropBaseSapling("oak_sapling", "acorns", new ItemStack(Blocks.LOG), new ItemStack(Blocks.SAPLING, 1, 0));

	public static CropCard cropSpruceSapling = (CropCard) new CropBaseSapling("spruce_sapling", "pine_cones", new ItemStack(Blocks.LOG, 1, 1), new ItemStack(Blocks.SAPLING, 1, 1));

	public static CropCard cropBirchSapling = (CropCard) new CropBaseSapling("birch_sapling", "catkins", new ItemStack(Blocks.LOG, 1, 2), new ItemStack(Blocks.SAPLING, 1, 2));

	public static CropCard cropJungleSapling = (CropCard) new CropBaseSapling("jungle_sapling", "seedling", new ItemStack(Blocks.LOG, 1, 3), new ItemStack(Blocks.SAPLING, 1, 3));

	public static CropCard cropAcaciaSapling = (CropCard) new CropBaseSapling("acacia_sapling", "seedling", new ItemStack(Blocks.LOG2), new ItemStack(Blocks.SAPLING, 1, 4));

	public static CropCard cropDarkOakSapling = (CropCard) new CropBaseSapling("dark_oak_sapling", "acorns", new ItemStack(Blocks.LOG2, 1, 1), new ItemStack(Blocks.SAPLING, 1, 5));
	...
	public static void registerCrops()
	{
		...
		GenericCropCard.create("blazereed")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.BLAZE_ROD), ItemName.dust.getItemStack((Enum) DustResourceType.sulfur) }).setAfterHarvestSize(1)
			.register();
		GenericCropCard.create("bobs_yer_uncle_ranks_berries")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.EMERALD) }).setAfterHarvestSize(1)
			.register();
		...
		GenericCropCard.create("corpse_plant")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.BONE), new ItemStack(Items.DYE, 1, 15), new ItemStack(Items.DYE, 1, 15) }).setAfterHarvestSize(1)
			.register();
		...
		GenericCropCard.create("egg_plant")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.CHICKEN), new ItemStack(Items.FEATHER), new ItemStack(Items.FEATHER), new ItemStack(Items.FEATHER) }).setGrowthSpeed(900)
		...
		GenericCropCard.create("meat_rose")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.BEEF), new ItemStack(Items.PORKCHOP), new ItemStack(Items.CHICKEN), new ItemStack(Items.MUTTON) }).setGrowthSpeed(1500)
			.setAfterHarvestSize(1)
			.register();
		...
		GenericCropCard.create("spidernip")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.SPIDER_EYE), new ItemStack(Blocks.WEB) }).setGrowthSpeed(600)
			.setAfterHarvestSize(1)
			.register();
		...
		GenericCropCard.create("withereed")
			...
			.setSpecialDrops(new ItemStack[] { new ItemStack(Items.COAL), new ItemStack(Items.COAL) }).setAfterHarvestSize(1)
			.register();
	}
	...
	public static void registerBaseSeeds()
	{
		...
		Crops.instance.registerBaseSeed(new ItemStack((Block) Blocks.CACTUS, 1, 32767), cropEatingPlant, 1, 1, 1, 1);
