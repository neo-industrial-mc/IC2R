...
public class ReflectionUtil {
  ...
  public static <T> T getValueRecursive(Object object, String fieldName)
  ...
  public static <T> T getValueRecursive(Object object, Class<?> type, boolean requireUnique)
      throws NoSuchFieldException {
  ...
  public static void setValue(Object object, Field field, Object value) {
    ...
    try {
      ...
      throw new RuntimeException(
          "can't set field " + field.getName() + " in " + object + " to " + value, e);
    }
  }
