...
public class SmeltingRecipeManager
  ...
  public MachineRecipeResult<ItemStack, ItemStack, ItemStack> apply(
  ...
  public enum SmeltingBridge
    ...
    public MachineRecipeResult<IRecipeInput, Collection<ItemStack>, ItemStack> apply(
        ItemStack input, boolean acceptTest) {
      MachineRecipeResult<ItemStack, ItemStack, ItemStack> normal =
          Recipes.furnace.apply(input, acceptTest);
      if (normal == null) {
        return null;
      }
