...
public class RecipeInputFluidContainer extends RecipeInputBase {
  ...
  public static List<ItemStack> getFluidContainer(Fluid fluid) {
    ...
    for (ItemStack stack : containerItems) {
      ...
      if (amount > 0 && container.getValue() != null) {
        Ic2FluidStack fs =
            FluidHandler.drainMb((ItemStack) container.getValue(), Integer.MAX_VALUE, true, null);
  ...
  public boolean matches(ItemStack subject) {
    ...
    return fs != null && !fs.isEmpty()
        ? fs.getFluid() == this.fluid && fs.getAmountMb() >= this.amount
        : this.fluid == null;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return obj != null
        ...
        && (other = (RecipeInputFluidContainer) obj).fluid == this.fluid
