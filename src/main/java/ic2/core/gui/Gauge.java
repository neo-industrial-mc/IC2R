...
public abstract class Gauge<T extends Gauge<T>> extends GuiElement<T> {
  ...
  public void drawBackground(int mouseX, int mouseY) {
    ...
    if (this.properties.bgWidth >= 0) {
      ...
      this.gui.drawTexturedRect(x + this.properties.bgXOffset, y + this.properties.bgYOffset, this.properties.bgWidth, this.properties.bgHeight, active ? this.properties.uBgActive : this.properties.uBgInactive, active ? this.properties.vBgActive : this.properties.vBgInactive);
      if (ratio <= 0.0D)
        return; 
    } 
  ...
  public enum GaugeStyle implements IGaugeStyle {
    Fuel((String)(new Gauge.GaugePropertyBuilder(112, 80, 13, 13, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withHover(0, 0, 14, 14).withBackground(0, 0, 16, 16, 96, 80).build()),
    Bucket((String)(new Gauge.GaugePropertyBuilder(110, 111, 14, 16, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withBackground(96, 111).build()),
    ProgressWind((String)(new Gauge.GaugePropertyBuilder(242, 91, 13, 13, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withBackground(242, 63, 242, 77).build()),
    ProgressArrow((String)(new Gauge.GaugePropertyBuilder(165, 16, 22, 15, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-5, 0, 32, 16, 160, 0).build()),
    ProgressArrowModern((String)(new Gauge.GaugePropertyBuilder(86, 234, 16, 10, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(0, 0, 16, 10, 70, 234).build()),
    ProgressArrowModernReversed((String)(new Gauge.GaugePropertyBuilder(70, 244, 16, 10, Gauge.GaugePropertyBuilder.GaugeOrientation.Left)).withBackground(0, 0, 16, 10, 86, 244).build()),
    ProgressCrush((String)(new Gauge.GaugePropertyBuilder(165, 52, 21, 11, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-5, -3, 32, 16, 160, 32).build()),
    ProgressTriangle((String)(new Gauge.GaugePropertyBuilder(165, 80, 22, 15, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-5, 0, 32, 16, 160, 64).build()),
    ProgressDrop((String)(new Gauge.GaugePropertyBuilder(165, 112, 22, 15, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-5, 0, 32, 16, 160, 96).build()),
    ProgressRecycler((String)(new Gauge.GaugePropertyBuilder(133, 80, 18, 15, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-5, 0, 32, 16, 128, 64).build()),
    ProgressMetalFormer((String)(new Gauge.GaugePropertyBuilder(200, 19, 46, 9, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-8, -3, 64, 16, 192, 0).build()),
    ProgressCentrifuge((String)(new Gauge.GaugePropertyBuilder(252, 33, 3, 28, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withBackground(-1, -1, 5, 30, 246, 32).build()),
    HeatCentrifuge((String)(new Gauge.GaugePropertyBuilder(225, 54, 20, 4, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withBackground(-1, -1, 22, 6, 224, 47).build()),
    HeatNuclearReactor((String)(new Gauge.GaugePropertyBuilder(0, 243, 100, 13, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUINuclearReactor.png")).build()),
    HeatSteamGenerator((String)(new Gauge.GaugePropertyBuilder(177, 1, 7, 76, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUISteamGenerator.png")).build()),
    CalcificationSteamGenerator((String)(new Gauge.GaugePropertyBuilder(187, 1, 7, 58, Gauge.GaugePropertyBuilder.GaugeOrientation.Up)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUISteamGenerator.png")).build()),
    ProgressCondenser((String)(new Gauge.GaugePropertyBuilder(1, 185, 82, 7, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUICondenser.png")).build()),
    HeatFermenter((String)(new Gauge.GaugePropertyBuilder(177, 10, 40, 3, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUIFermenter.png")).build()),
    ProgressFermenter((String)(new Gauge.GaugePropertyBuilder(177, 1, 40, 7, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withHoverBorder(1).withTexture(new ResourceLocation("ic2", "textures/gui/GUIFermenter.png")).build()),
    ProgressOreWasher((String)(new Gauge.GaugePropertyBuilder(177, 118, 18, 18, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withTexture(new ResourceLocation("ic2", "textures/gui/GUIOreWashingPlant.png")).withBackground(-1, -1, 20, 19, 102, 38).build()),
    ProgressBlockCutter((String)(new Gauge.GaugePropertyBuilder(176, 15, 46, 17, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withTexture(new ResourceLocation("ic2", "textures/gui/GUIBlockCutter.png")).withBackground(55, 33).build()),
    ProgressLongArrow((String)(new Gauge.GaugePropertyBuilder(176, 15, 34, 13, Gauge.GaugePropertyBuilder.GaugeOrientation.Right)).withTexture(new ResourceLocation("ic2", "textures/gui/GUI_Canner_Classic.png")).withBackground(74, 36).build());
