...
public class DynamicHandHeldContainer<T extends HandHeldInventory> extends DynamicContainer<T> {
  protected DynamicHandHeldContainer(
  ...
  public static DynamicHandHeldContainer<HandHeldInventory> create(
      int syncId, Inventory playerInventory, HandHeldInventory base, GuiParser.GuiNode guiNode) {
    return new DynamicHandHeldContainer<>(
        Ic2ScreenHandlers.DYNAMIC_ITEM, syncId, playerInventory, base, guiNode);
  }
