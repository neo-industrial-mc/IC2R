...
public class Image extends GuiElement<Image> {
  ...
  public void drawBackground(int mouseX, int mouseY) {
    ...
    if (texture != null) {
      ...
      double widthScale = (this.baseWidth > 0) ? (1.0D / this.baseWidth) : (1.0D / texture.getCanvasWidth());
      double heightScale = (this.baseHeight > 0) ? (1.0D / this.baseHeight) : (1.0D / texture.getCanvasHeight());
