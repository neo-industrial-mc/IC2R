...
public class Image extends GuiElement<Image> {
  ...
  public static Image create(
    ...
    return create(
        ...
        baseWidth,
        baseHeight,
        new OverlaySupplier(uS, vS, uE, vE));
  }
  ...
  public static Image create(
    ...
    return new Image(
        gui, x, y, width, height, texture, baseWidth, baseHeight, overlay, autoWidth, autoHeight);
  }
  ...
  public void drawBackground(GuiGraphics guiGraphics, int mouseX, int mouseY) {
    ...
    if (texture != null) {
      ...
      double widthScale =
          this.baseWidth > 0 ? 1.0 / this.baseWidth : 1.0 / texture.getCanvasWidth();
      double heightScale =
          this.baseHeight > 0 ? 1.0 / this.baseHeight : 1.0 / texture.getCanvasHeight();
