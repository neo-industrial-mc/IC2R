...
public class Text extends GuiElement<Text> {
   ...
   public static Text create(
      GuiIC2<?> gui, int x, int y, int width, int height, TextProvider.ITextProvider textProvider, int color, boolean shadow, boolean centerX, boolean centerY
   ) {
   ...
   public static Text createRightAligned(
      ...
      return create(
         gui, x, y, width, height, textProvider, Suppliers.ofInstance(color), shadow, xOffset - getWidth(gui, textProvider), yOffset, centerX, centerY
      );
   }
   ...
   public enum TextAlignment {
      ...
      private static Map<String, Text.TextAlignment> getMap() {
         ...
         for (Text.TextAlignment style : values) {
