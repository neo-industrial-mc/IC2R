...
public class VdUtil {
   ...
   public static void addCuboid(
      ...
      addCuboid(
         xS, yS, zS, xE, yE, zE, spriteU, spriteV, sprite.getMaxU() - spriteU, sprite.getMaxV() - spriteV, faces, sprite, faceQuads, generalQuads
      );
   }
   ...
   public static void addFlippedCuboid(
      ...
      addCuboid(
         xS, yS, zS, xE, yE, zE, spriteU, spriteV, sprite.getMinU() - spriteU, sprite.getMinV() - spriteV, faces, sprite, faceQuads, generalQuads
      );
   }
   ...
   private static void addCuboidWithYOffset(
      float xS,
      float yS,
      float zS,
      float xE,
