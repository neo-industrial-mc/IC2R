...
public class LaserBulletEntityRenderer extends EntityRenderer<LaserBulletEntity> {
  ...
  public void render(
    ...
    matrixStack.mulPose(
        Axis.YP.rotationDegrees(Mth.lerp(g, entity.yRotO, entity.getYRot()) - 90.0F));
    ...
    VertexConsumer vertexConsumer =
        vertexConsumerProvider.getBuffer(RenderType.entityCutout(this.getTextureLocation(entity)));
  ...
  public void vertex(
      ...
      int light) {
    vertexConsumer
        .addVertex(pose, (float) x, (float) y, (float) z)
