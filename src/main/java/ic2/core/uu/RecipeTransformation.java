...
public class RecipeTransformation {
  ...
  public RecipeTransformation(
      double transformCost, List<List<LeanItemStack>> inputs, LeanItemStack... outputs) {
    this(transformCost, inputs, Arrays.asList(outputs));
  }

  public RecipeTransformation(
      double transformCost, List<List<LeanItemStack>> inputs, List<LeanItemStack> outputs) {
  ...
  private List<LeanItemStack> mergeEqualLists(
      List<LeanItemStack> listA, List<LeanItemStack> listB) {
