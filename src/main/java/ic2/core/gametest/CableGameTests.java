...
public class CableGameTests
{
	...
	// cables connect when placed next to each other and drop the connection again once the neighbor is gone
	...
	// a machine placed and removed next to an existing cable must update the cable's connection via neighborChanged
	@GameTest(template = EMPTY)
