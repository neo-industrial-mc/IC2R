...
{
	private static final ConcurrentMap<Integer, WorldData> idxClient = FMLCommonHandler.instance().getSide().isClient() ? new ConcurrentHashMap<>() : null;
	private static final ConcurrentMap<Integer, WorldData> idxServer = new ConcurrentHashMap<>();
