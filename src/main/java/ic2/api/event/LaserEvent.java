...
public class LaserEvent extends LevelEvent implements ICancellableEvent
{
	...
	public static class LaserHitsBlockEvent extends LaserEvent
	{
		...
		public LaserHitsBlockEvent(Level world, Entity lasershot, LivingEntity owner, float range, float power, int blockBreaks, boolean explosive, boolean smelt, BlockPos pos, Direction side, float dropChance, boolean removeBlock, boolean dropBlock)
		{
			super(world, lasershot, owner, range, power, blockBreaks, explosive, smelt);
			this.pos = pos;
			this.side = side;
	...
	public static class LaserExplodesEvent extends LaserEvent
	{
		...
		public LaserExplodesEvent(Level world, Entity lasershot, LivingEntity owner, float range, float power, int blockBreaks, boolean explosive, boolean smelt, float explosionPower, float explosionDropRate, float explosionEntityDamage)
		{
			super(world, lasershot, owner, range, power, blockBreaks, explosive, smelt);
