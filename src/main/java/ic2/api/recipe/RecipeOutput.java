...
public final class RecipeOutput {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof RecipeOutput) {
      ...
      if (this.items.size() == ro.items.size() && ((this.metadata == null && ro.metadata == null) || (this.metadata != null && ro.metadata != null && this.metadata
        .equals(ro.metadata)))) {
        ...
        while (itA.hasNext() && itB.hasNext()) {
          ...
          if (ItemStack.func_77989_b(stackA, stackB))
            return false; 
        } 
        return true;
      } 
