...
public class SimpleSVD<T extends SimpleMatrix> {
  ...
  public SimpleSVD(DenseMatrix64F mat, boolean compact) {
    ...
    if (!this.svd.decompose((Matrix64F)mat))
      throw new RuntimeException("Decomposition failed"); 
    this.U = (T)SimpleMatrix.wrap((DenseMatrix64F)this.svd.getU(null, false));
    this.W = (T)SimpleMatrix.wrap((DenseMatrix64F)this.svd.getW(null));
    this.V = (T)SimpleMatrix.wrap((DenseMatrix64F)this.svd.getV(null, false));
