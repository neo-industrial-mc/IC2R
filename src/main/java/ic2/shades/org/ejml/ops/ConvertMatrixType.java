...
{
    public static void convert(final Matrix64F input, final Matrix64F output) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix2x2_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix3x3_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix4x4_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix5x5_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix6x6_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static FixedMatrix2x2_64F convert(final DenseMatrix64F input, FixedMatrix2x2_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix3x3_64F convert(final DenseMatrix64F input, FixedMatrix3x3_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix4x4_64F convert(final DenseMatrix64F input, FixedMatrix4x4_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix5x5_64F convert(final DenseMatrix64F input, FixedMatrix5x5_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix6x6_64F convert(final DenseMatrix64F input, FixedMatrix6x6_64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix2_64F input, DenseMatrix64F output) {
        if (output == null) {
        ...
        final int length = Math.max(output.getNumRows(), output.getNumCols());
        if (length != 2) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix3_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix4_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix5_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static DenseMatrix64F convert(final FixedMatrix6_64F input, DenseMatrix64F output) {
        if (output == null) {
    ...
    public static FixedMatrix2_64F convert(final DenseMatrix64F input, FixedMatrix2_64F output) {
        if (output == null) {
        ...
        final int length = Math.max(input.getNumRows(), input.getNumCols());
        if (length != 2) {
            throw new IllegalArgumentException("Length of input vector is not 2.  It is " + length);
        }
    ...
    public static FixedMatrix3_64F convert(final DenseMatrix64F input, FixedMatrix3_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix4_64F convert(final DenseMatrix64F input, FixedMatrix4_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix5_64F convert(final DenseMatrix64F input, FixedMatrix5_64F output) {
        if (output == null) {
    ...
    public static FixedMatrix6_64F convert(final DenseMatrix64F input, FixedMatrix6_64F output) {
        if (output == null) {
    ...
    public static void convert(final DenseMatrix64F input, final BlockMatrix64F output) {
        BlockMatrixOps.convert(input, output);
    }
    
    public static DenseMatrix64F convert(final BlockMatrix64F input, final DenseMatrix64F output) {
