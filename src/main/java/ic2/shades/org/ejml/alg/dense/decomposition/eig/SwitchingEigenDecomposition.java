...
public class SwitchingEigenDecomposition implements EigenDecomposition<DenseMatrix64F>
{
    ...
    public SwitchingEigenDecomposition(final int matrixSize, final boolean computeVectors, final double tol) {
    ...
    public SwitchingEigenDecomposition(final int matrixSize) {
