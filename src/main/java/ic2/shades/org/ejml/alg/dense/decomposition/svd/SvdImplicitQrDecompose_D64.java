...
public class SvdImplicitQrDecompose_D64 implements SingularValueDecomposition<DenseMatrix64F>
{
	...
	private final boolean canUseTallBidiagonal;
	private BidiagonalDecomposition<DenseMatrix64F> bidiag;
	private final SvdImplicitQrAlgorithm qralg = new SvdImplicitQrAlgorithm();
	double[] diag;
	double[] off;
	...
	private final boolean prefComputeU;
	private final boolean prefComputeV;
	private boolean transposed;
	private final DenseMatrix64F A_mod = new DenseMatrix64F(1, 1);
