...
public class TridiagonalDecompositionHouseholder_B64 implements TridiagonalSimilarDecomposition<BlockMatrix64F> {
  ...
  public BlockMatrix64F getQ(BlockMatrix64F Q, boolean transposed) {
    ...
    D1Submatrix64F subQ = new D1Submatrix64F((D1Matrix64F)Q);
    D1Submatrix64F subU = new D1Submatrix64F((D1Matrix64F)this.A);
    D1Submatrix64F subW = new D1Submatrix64F((D1Matrix64F)this.V);
    D1Submatrix64F tmp = new D1Submatrix64F((D1Matrix64F)this.tmp);
    ...
    if (start < 0)
      start = 0; 
    int i;
    for (i = start; i >= 0; i -= this.A.blockLength) {
  ...
  public boolean decompose(BlockMatrix64F orig) {
    ...
    init(orig);
    D1Submatrix64F subA = new D1Submatrix64F((D1Matrix64F)this.A);
    D1Submatrix64F subV = new D1Submatrix64F((D1Matrix64F)this.V);
    D1Submatrix64F subU = new D1Submatrix64F((D1Matrix64F)this.A);
    int N = orig.numCols;
    int i;
    for (i = 0; i < N; i += this.A.blockLength) {
      ...
      if (subU.row1 < orig.numCols) {
        ...
        subU.set(this.A.blockLength - 1, this.A.blockLength, 1.0D);
