...
public class TridiagonalDecompositionHouseholder_B64 implements TridiagonalSimilarDecomposition<BlockMatrix64F>
{
	...
	protected final BlockMatrix64F V = new BlockMatrix64F(1, 1);
	protected final BlockMatrix64F tmp = new BlockMatrix64F(1, 1);
	protected double[] gammas = new double[1];
	protected final DenseMatrix64F zerosM = new DenseMatrix64F(1, 1);
