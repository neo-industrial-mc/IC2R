   ...
   public static double det6(RowD1Matrix64F mat) {
      ...
      ret += data[0]
         * (
            a11
                  * (
                     a22 * (a33 * (a44 * a55 - a45 * a54) - a34 * (a43 * a55 - a45 * a53) + a35 * (a43 * a54 - a44 * a53))
               ...
               + a13
                  * (
                     a21 * (a32 * (a44 * a55 - a45 * a54) - a34 * (a42 * a55 - a45 * a52) + a35 * (a42 * a54 - a44 * a52))
               ...
               + a15
                  * (
                     a21 * (a32 * (a43 * a54 - a44 * a53) - a33 * (a42 * a54 - a44 * a52) + a34 * (a42 * a53 - a43 * a52))
