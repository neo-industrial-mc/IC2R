...
public class QRDecompositionHouseholder_B64 implements QRDecomposition<BlockMatrix64F> {
  ...
  private D1Submatrix64F W = new D1Submatrix64F((D1Matrix64F)this.dataW);
  
  private D1Submatrix64F WTA = new D1Submatrix64F((D1Matrix64F)this.dataWTA);
  ...
  public void applyQ(BlockMatrix64F B, boolean isIdentity) {
    ...
    D1Submatrix64F subB = new D1Submatrix64F((D1Matrix64F)B);
    this.W.col0 = this.W.row0 = 0;
    this.W.row1 = this.dataA.numRows;
    ...
    if (start < 0)
      start = 0; 
    int i;
    for (i = start; i >= 0; i -= this.blockLength) {
      this.Y.col0 = i;
  ...
  public void applyQTran(BlockMatrix64F B) {
    ...
    this.WTA.row0 = this.WTA.col0 = 0;
    int i;
    for (i = 0; i < minDimen; i += this.blockLength) {
      this.Y.col0 = i;
      this.Y.col1 = Math.min(this.Y.col0 + this.blockLength, this.dataA.numCols);
      this.Y.row0 = i;
      subB.row0 = i;
  ...
  private void setup(BlockMatrix64F orig) {
    ...
    this.dataA = orig;
    this.A.original = (D1Matrix64F)this.dataA;
    ...
    this.Y.original = (D1Matrix64F)orig;
    this.W.row1 = orig.numRows;
