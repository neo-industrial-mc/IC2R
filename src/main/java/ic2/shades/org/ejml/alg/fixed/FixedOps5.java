...
public class FixedOps5 {
   ...
   public static boolean invert(FixedMatrix5x5_64F a, FixedMatrix5x5_64F inv) {
      ...
      double m11 = a22 * (a33 * (a44 * a55 - a45 * a54) - a34 * (a43 * a55 - a45 * a53) + a35 * (a43 * a54 - a44 * a53))
      ...
      double m12 = -(
         a21 * (a33 * (a44 * a55 - a45 * a54) - a34 * (a43 * a55 - a45 * a53) + a35 * (a43 * a54 - a44 * a53))
      ...
      double m13 = a21 * (a32 * (a44 * a55 - a45 * a54) - a34 * (a42 * a55 - a45 * a52) + a35 * (a42 * a54 - a44 * a52))
      ...
      double m14 = -(
         a21 * (a32 * (a43 * a55 - a45 * a53) - a33 * (a42 * a55 - a45 * a52) + a35 * (a42 * a53 - a43 * a52))
      ...
      double m15 = a21 * (a32 * (a43 * a54 - a44 * a53) - a33 * (a42 * a54 - a44 * a52) + a34 * (a42 * a53 - a43 * a52))
      ...
      double m21 = -(
         a12 * (a33 * (a44 * a55 - a45 * a54) - a34 * (a43 * a55 - a45 * a53) + a35 * (a43 * a54 - a44 * a53))
            - a13 * (a32 * (a44 * a55 - a45 * a54) - a34 * (a42 * a55 - a45 * a52) + a35 * (a42 * a54 - a44 * a52))
            + a14 * (a32 * (a43 * a55 - a45 * a53) - a33 * (a42 * a55 - a45 * a52) + a35 * (a42 * a53 - a43 * a52))
            - a15 * (a32 * (a43 * a54 - a44 * a53) - a33 * (a42 * a54 - a44 * a52) + a34 * (a42 * a53 - a43 * a52))
      );
      double m22 = a11 * (a33 * (a44 * a55 - a45 * a54) - a34 * (a43 * a55 - a45 * a53) + a35 * (a43 * a54 - a44 * a53))
      ...
      double m23 = -(
         a11 * (a32 * (a44 * a55 - a45 * a54) - a34 * (a42 * a55 - a45 * a52) + a35 * (a42 * a54 - a44 * a52))
            - a12 * (a31 * (a44 * a55 - a45 * a54) - a34 * (a41 * a55 - a45 * a51) + a35 * (a41 * a54 - a44 * a51))
            + a14 * (a31 * (a42 * a55 - a45 * a52) - a32 * (a41 * a55 - a45 * a51) + a35 * (a41 * a52 - a42 * a51))
            - a15 * (a31 * (a42 * a54 - a44 * a52) - a32 * (a41 * a54 - a44 * a51) + a34 * (a41 * a52 - a42 * a51))
      );
      double m24 = a11 * (a32 * (a43 * a55 - a45 * a53) - a33 * (a42 * a55 - a45 * a52) + a35 * (a42 * a53 - a43 * a52))
      ...
      double m25 = -(
         a11 * (a32 * (a43 * a54 - a44 * a53) - a33 * (a42 * a54 - a44 * a52) + a34 * (a42 * a53 - a43 * a52))
            - a12 * (a31 * (a43 * a54 - a44 * a53) - a33 * (a41 * a54 - a44 * a51) + a34 * (a41 * a53 - a43 * a51))
            + a13 * (a31 * (a42 * a54 - a44 * a52) - a32 * (a41 * a54 - a44 * a51) + a34 * (a41 * a52 - a42 * a51))
            - a14 * (a31 * (a42 * a53 - a43 * a52) - a32 * (a41 * a53 - a43 * a51) + a33 * (a41 * a52 - a42 * a51))
      );
      double m31 = a12 * (a23 * (a44 * a55 - a45 * a54) - a24 * (a43 * a55 - a45 * a53) + a25 * (a43 * a54 - a44 * a53))
      ...
      double m32 = -(
         a11 * (a23 * (a44 * a55 - a45 * a54) - a24 * (a43 * a55 - a45 * a53) + a25 * (a43 * a54 - a44 * a53))
            - a13 * (a21 * (a44 * a55 - a45 * a54) - a24 * (a41 * a55 - a45 * a51) + a25 * (a41 * a54 - a44 * a51))
            + a14 * (a21 * (a43 * a55 - a45 * a53) - a23 * (a41 * a55 - a45 * a51) + a25 * (a41 * a53 - a43 * a51))
            - a15 * (a21 * (a43 * a54 - a44 * a53) - a23 * (a41 * a54 - a44 * a51) + a24 * (a41 * a53 - a43 * a51))
      );
      double m33 = a11 * (a22 * (a44 * a55 - a45 * a54) - a24 * (a42 * a55 - a45 * a52) + a25 * (a42 * a54 - a44 * a52))
      ...
      double m34 = -(
         a11 * (a22 * (a43 * a55 - a45 * a53) - a23 * (a42 * a55 - a45 * a52) + a25 * (a42 * a53 - a43 * a52))
            - a12 * (a21 * (a43 * a55 - a45 * a53) - a23 * (a41 * a55 - a45 * a51) + a25 * (a41 * a53 - a43 * a51))
            + a13 * (a21 * (a42 * a55 - a45 * a52) - a22 * (a41 * a55 - a45 * a51) + a25 * (a41 * a52 - a42 * a51))
            - a15 * (a21 * (a42 * a53 - a43 * a52) - a22 * (a41 * a53 - a43 * a51) + a23 * (a41 * a52 - a42 * a51))
      );
      double m35 = a11 * (a22 * (a43 * a54 - a44 * a53) - a23 * (a42 * a54 - a44 * a52) + a24 * (a42 * a53 - a43 * a52))
      ...
      double m41 = -(
         a12 * (a23 * (a34 * a55 - a35 * a54) - a24 * (a33 * a55 - a35 * a53) + a25 * (a33 * a54 - a34 * a53))
            - a13 * (a22 * (a34 * a55 - a35 * a54) - a24 * (a32 * a55 - a35 * a52) + a25 * (a32 * a54 - a34 * a52))
            + a14 * (a22 * (a33 * a55 - a35 * a53) - a23 * (a32 * a55 - a35 * a52) + a25 * (a32 * a53 - a33 * a52))
            - a15 * (a22 * (a33 * a54 - a34 * a53) - a23 * (a32 * a54 - a34 * a52) + a24 * (a32 * a53 - a33 * a52))
      );
      double m42 = a11 * (a23 * (a34 * a55 - a35 * a54) - a24 * (a33 * a55 - a35 * a53) + a25 * (a33 * a54 - a34 * a53))
      ...
      double m43 = -(
         a11 * (a22 * (a34 * a55 - a35 * a54) - a24 * (a32 * a55 - a35 * a52) + a25 * (a32 * a54 - a34 * a52))
            - a12 * (a21 * (a34 * a55 - a35 * a54) - a24 * (a31 * a55 - a35 * a51) + a25 * (a31 * a54 - a34 * a51))
            + a14 * (a21 * (a32 * a55 - a35 * a52) - a22 * (a31 * a55 - a35 * a51) + a25 * (a31 * a52 - a32 * a51))
            - a15 * (a21 * (a32 * a54 - a34 * a52) - a22 * (a31 * a54 - a34 * a51) + a24 * (a31 * a52 - a32 * a51))
      );
      double m44 = a11 * (a22 * (a33 * a55 - a35 * a53) - a23 * (a32 * a55 - a35 * a52) + a25 * (a32 * a53 - a33 * a52))
      ...
      double m45 = -(
         a11 * (a22 * (a33 * a54 - a34 * a53) - a23 * (a32 * a54 - a34 * a52) + a24 * (a32 * a53 - a33 * a52))
            - a12 * (a21 * (a33 * a54 - a34 * a53) - a23 * (a31 * a54 - a34 * a51) + a24 * (a31 * a53 - a33 * a51))
            + a13 * (a21 * (a32 * a54 - a34 * a52) - a22 * (a31 * a54 - a34 * a51) + a24 * (a31 * a52 - a32 * a51))
            - a14 * (a21 * (a32 * a53 - a33 * a52) - a22 * (a31 * a53 - a33 * a51) + a23 * (a31 * a52 - a32 * a51))
      );
      double m51 = a12 * (a23 * (a34 * a45 - a35 * a44) - a24 * (a33 * a45 - a35 * a43) + a25 * (a33 * a44 - a34 * a43))
      ...
      double m52 = -(
         a11 * (a23 * (a34 * a45 - a35 * a44) - a24 * (a33 * a45 - a35 * a43) + a25 * (a33 * a44 - a34 * a43))
            - a13 * (a21 * (a34 * a45 - a35 * a44) - a24 * (a31 * a45 - a35 * a41) + a25 * (a31 * a44 - a34 * a41))
            + a14 * (a21 * (a33 * a45 - a35 * a43) - a23 * (a31 * a45 - a35 * a41) + a25 * (a31 * a43 - a33 * a41))
            - a15 * (a21 * (a33 * a44 - a34 * a43) - a23 * (a31 * a44 - a34 * a41) + a24 * (a31 * a43 - a33 * a41))
      );
      double m53 = a11 * (a22 * (a34 * a45 - a35 * a44) - a24 * (a32 * a45 - a35 * a42) + a25 * (a32 * a44 - a34 * a42))
      ...
      double m54 = -(
         a11 * (a22 * (a33 * a45 - a35 * a43) - a23 * (a32 * a45 - a35 * a42) + a25 * (a32 * a43 - a33 * a42))
            - a12 * (a21 * (a33 * a45 - a35 * a43) - a23 * (a31 * a45 - a35 * a41) + a25 * (a31 * a43 - a33 * a41))
            + a13 * (a21 * (a32 * a45 - a35 * a42) - a22 * (a31 * a45 - a35 * a41) + a25 * (a31 * a42 - a32 * a41))
            - a15 * (a21 * (a32 * a43 - a33 * a42) - a22 * (a31 * a43 - a33 * a41) + a23 * (a31 * a42 - a32 * a41))
      );
      double m55 = a11 * (a22 * (a33 * a44 - a34 * a43) - a23 * (a32 * a44 - a34 * a42) + a24 * (a32 * a43 - a33 * a42))
   ...
   public static double elementMaxAbs(FixedMatrix5x5_64F a) {
      ...
      return Math.max(max, Math.abs(a.a55));
   }
   ...
   public static double elementMinAbs(FixedMatrix5x5_64F a) {
      ...
      return Math.min(min, Math.abs(a.a55));
   }
