...
public class BlockCholeskyOuterSolver implements LinearSolver<BlockMatrix64F> {
  ...
  public double quality() {
    return SpecializedOps.qualityTriangular(false, (D1Matrix64F)this.chol.getT(null));
  }
  ...
  public void solve(BlockMatrix64F B, BlockMatrix64F X) {
    ...
    D1Submatrix64F L = new D1Submatrix64F((D1Matrix64F)this.chol.getT(null));
    if (X != null) {
  ...
  public void invert(BlockMatrix64F A_inv) {
    BlockMatrix64F T = this.chol.getT(null);
