...
record Ic2FluidStackImpl(FluidStack parent) implements Ic2FluidStack {
  ...
  public Ic2FluidStack copy() {
    return this.parent.getComponentsPatch().isEmpty()
        ? Ic2FluidStack.create(this.parent.getFluid(), this.parent.getAmount())
        : new Ic2FluidStackImpl(this.parent.copy());
  }
  ...
  public boolean hasExactFluid(Ic2FluidStack fs) {
    return fs instanceof Ic2FluidStackImpl
        ? FluidStack.isSameFluidSameComponents(this.parent, ((Ic2FluidStackImpl) fs).parent)
  ...
  public void toNbt(CompoundTag nbt) {
    ...
    nbt.putString(
        "FluidName", String.valueOf(BuiltInRegistries.FLUID.getKey(this.parent.getFluid())));
  ...
  public boolean equals(Object obj) {
    if (obj instanceof Ic2FluidStack) {
      ...
      if (this.parent.getAmount() != o.getAmountMb() || this.parent.getFluid() != o.getFluid()) {
        ...
        return o instanceof Ic2FluidStackImpl
            ? FluidStack.isSameFluidSameComponents(this.parent, ((Ic2FluidStackImpl) o).parent)
            : this.parent.getComponentsPatch().isEmpty();
      }
    }
  }
  ...
  public String toString() {
    ...
    return String.format(
        ...
        this.parent.getComponentsPatch().isEmpty()
            ? "(-)"
            : this.parent.getComponentsPatch().toString());
  }
}
