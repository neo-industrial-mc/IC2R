...
public class CannerBottleCategory extends IORecipeCategory<CannerBottleRecipeWrapper> {
  ...
  public CannerBottleCategory(
      Ic2TileEntityBlock teBlock,
      RecipeType<CannerBottleRecipeWrapper> recipeType,
      IGuiHelper guiHelper) {
    super(teBlock);
    this.recipeType = recipeType;
    DynamicCategory.parseWidgets(
        teBlock,
        guiHelper,
  ...
  public void setRecipe(
      ...
      @NotNull CannerBottleRecipeWrapper recipe,
  ...
  @Override
  public void draw(
      CannerBottleRecipeWrapper recipe,
