 ...
 * (Plugins → IC2), stored in Jade's plugin config files.
 */
public final class Ic2JadePluginConfigs
{
	// Machine text lines
	...
	private static final Predicate<String> COLOR = Ic2JadePluginConfigs::isValidColorString;

	private Ic2JadePluginConfigs()
	{
	}
