...
/**
 * Client-side helpers for reading IC2 options from Jade's plugin config UI.
...
public final class JadeConfigHelper
{
	...
	{
		return parseColor(plugin().getString(Ic2JadePluginConfigs.PROGRESS_COLOR2), progressColor());
	}
