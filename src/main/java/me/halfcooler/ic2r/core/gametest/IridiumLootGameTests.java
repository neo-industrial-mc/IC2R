...
public final class IridiumLootGameTests
{
	...
	public static void vanillaDungeonLootCanGenerateIridium(GameTestHelper helper)
	{
		...
		for (int i = 0; i < SAMPLE_COUNT; i++)
		{
			...
			{
				if (stack.is(Ic2rItems.IRIDIUM_ORE) || stack.is(Ic2rItems.IRIDIUM_SHARD))
				{
					helper.succeed();
					return;
				}
		...
		helper.fail("Vanilla simple dungeon loot generated no IC2R iridium in " + SAMPLE_COUNT + " samples");
	}
}
