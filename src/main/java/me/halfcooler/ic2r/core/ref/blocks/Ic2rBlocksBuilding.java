...
public final class Ic2rBlocksBuilding
{
	...
	public static final DeferredHolder<Block, Block> REINFORCED_DOOR = EnvProxyForge.BLOCKS.register("reinforced_door", () -> new DoorBlock(BlockSetType.IRON, Properties.of().strength(50.0F, 150.0F).noOcclusion().sound(SoundType.METAL)));
