...
public final class Ic2rBlocksResources
{
	...
	public static final DeferredHolder<Block, Block> DEEPSLATE_LEAD_ORE = EnvProxyForge.BLOCKS.register("deepslate_lead_ore", () -> new Block(Properties.of().mapColor(MapColor.DEEPSLATE).strength(3.0F, 6.0F).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
	public static final DeferredHolder<Block, Block> DEEPSLATE_TIN_ORE = EnvProxyForge.BLOCKS.register("deepslate_tin_ore", () -> new Block(Properties.of().mapColor(MapColor.DEEPSLATE).strength(4.0F, 7.0F).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
	public static final DeferredHolder<Block, Block> DEEPSLATE_URANIUM_ORE = EnvProxyForge.BLOCKS.register("deepslate_uranium_ore", () -> new Block(Properties.of().mapColor(MapColor.DEEPSLATE).strength(5.0F, 8.0F).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));
	public static final DeferredHolder<Block, Block> RAW_LEAD_BLOCK = EnvProxyForge.BLOCKS.register("raw_lead_block", () -> new Block(Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(3.0F, 11.0F).requiresCorrectToolForDrops()));
	public static final DeferredHolder<Block, Block> RAW_TIN_BLOCK = EnvProxyForge.BLOCKS.register("raw_tin_block", () -> new Block(Properties.of().mapColor(MapColor.SNOW).strength(4.0F, 12.0F).requiresCorrectToolForDrops()));
	public static final DeferredHolder<Block, Block> RAW_URANIUM_BLOCK = EnvProxyForge.BLOCKS.register("raw_uranium_block", () -> new Block(Properties.of().mapColor(MapColor.COLOR_GREEN).strength(5.0F, 13.0F).requiresCorrectToolForDrops()));
	public static final DeferredHolder<Block, Block> BRONZE_BLOCK = EnvProxyForge.BLOCKS.register("bronze_block", () -> new Block(Properties.of().strength(5.0F, 10.0F).requiresCorrectToolForDrops().sound(SoundType.METAL)));
	public static final DeferredHolder<Block, Block> LEAD_BLOCK = EnvProxyForge.BLOCKS.register("lead_block", () -> new Block(Properties.of().strength(4.0F, 10.0F).requiresCorrectToolForDrops().sound(SoundType.METAL)));
