...
public final class Ic2rBlocksWiring
{
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> GLASS_FIBRE_FOAM_CABLE = EnvProxyForge.BLOCKS.register("glass_fibre_foam_cable", () -> FoamCableBlock.create(Properties.of().strength(0.5F, 5.0F).sound(SoundType.GLASS), CableType.glass, 0));
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> COPPER_FOAM_CABLE = EnvProxyForge.BLOCKS.register("copper_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.copper, 0));
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> GOLD_FOAM_CABLE = EnvProxyForge.BLOCKS.register("gold_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.gold, 0));
	public static final DeferredHolder<Block, Block> GOLD_CABLE = EnvProxyForge.BLOCKS.register("gold_cable", () -> CableBlock.create(cableSettings, CableType.gold, 0, GOLD_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("iron_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.iron, 0));
	public static final DeferredHolder<Block, Block> IRON_CABLE = EnvProxyForge.BLOCKS.register("iron_cable", () -> CableBlock.create(cableSettings, CableType.iron, 0, IRON_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> TIN_FOAM_CABLE = EnvProxyForge.BLOCKS.register("tin_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.tin, 0));
	public static final DeferredHolder<Block, Block> TIN_CABLE = EnvProxyForge.BLOCKS.register("tin_cable", () -> CableBlock.create(cableSettings, CableType.tin, 0, TIN_FOAM_CABLE.get()));
	public static final DeferredHolder<DetectorFoamCableBlock, DetectorFoamCableBlock> DETECTOR_FOAM_CABLE = EnvProxyForge.BLOCKS.register("detector_foam_cable", () -> DetectorFoamCableBlock.create(cableSettings));
	...
	public static final DeferredHolder<SplitterFoamCableBlock, SplitterFoamCableBlock> SPLITTER_FOAM_CABLE = EnvProxyForge.BLOCKS.register("splitter_foam_cable", () -> SplitterFoamCableBlock.create(cableSettings));
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> INSULATED_COPPER_FOAM_CABLE = EnvProxyForge.BLOCKS.register("insulated_copper_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.copper, 1));
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> INSULATED_GOLD_FOAM_CABLE = EnvProxyForge.BLOCKS.register("insulated_gold_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.gold, 1));
	public static final DeferredHolder<Block, Block> INSULATED_GOLD_CABLE = EnvProxyForge.BLOCKS.register("insulated_gold_cable", () -> CableBlock.create(insulatedCableSettings, CableType.gold, 1, INSULATED_GOLD_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> DOUBLE_INSULATED_GOLD_FOAM_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_gold_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.gold, 2));
	public static final DeferredHolder<Block, Block> DOUBLE_INSULATED_GOLD_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_gold_cable", () -> CableBlock.create(insulatedCableSettings, CableType.gold, 2, DOUBLE_INSULATED_GOLD_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 1));
	public static final DeferredHolder<Block, Block> INSULATED_IRON_CABLE = EnvProxyForge.BLOCKS.register("insulated_iron_cable", () -> CableBlock.create(insulatedCableSettings, CableType.iron, 1, INSULATED_IRON_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> DOUBLE_INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 2));
	public static final DeferredHolder<Block, Block> DOUBLE_INSULATED_IRON_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_iron_cable", () -> CableBlock.create(insulatedCableSettings, CableType.iron, 2, DOUBLE_INSULATED_IRON_FOAM_CABLE.get()));
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> TRIPLE_INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("triple_insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 3));
	...
	public static final DeferredHolder<FoamCableBlock, FoamCableBlock> INSULATED_TIN_FOAM_CABLE = EnvProxyForge.BLOCKS.register("insulated_tin_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.tin, 1));
