...
import me.halfcooler.ic2r.core.block.wiring.*;
...
public final class Ic2rBlocksWiring
{
	...
	public static final DeferredHolder<Block, FoamCableBlock> IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("iron_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.iron, 0));
	...
	public static final DeferredHolder<Block, FoamCableBlock> TIN_FOAM_CABLE = EnvProxyForge.BLOCKS.register("tin_foam_cable", () -> FoamCableBlock.create(cableSettings, CableType.tin, 0));
	...
	public static final DeferredHolder<Block, DetectorFoamCableBlock> DETECTOR_FOAM_CABLE = EnvProxyForge.BLOCKS.register("detector_foam_cable", () -> DetectorFoamCableBlock.create(cableSettings));
	...
	public static final DeferredHolder<Block, FoamCableBlock> DOUBLE_INSULATED_GOLD_FOAM_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_gold_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.gold, 2));
	...
	public static final DeferredHolder<Block, FoamCableBlock> INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 1));
	...
	public static final DeferredHolder<Block, FoamCableBlock> DOUBLE_INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("double_insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 2));
	...
	public static final DeferredHolder<Block, FoamCableBlock> TRIPLE_INSULATED_IRON_FOAM_CABLE = EnvProxyForge.BLOCKS.register("triple_insulated_iron_foam_cable", () -> FoamCableBlock.create(insulatedCableSettings, CableType.iron, 3));
