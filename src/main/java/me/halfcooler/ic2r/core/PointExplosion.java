 ...
 * <p>
 * Mirrors classic IC2R PointExplosion + vanilla finalize behavior:
...
public class PointExplosion extends Explosion
{
	...
	public void doExplosion()
	{
		...
		if (!IC2R.envProxy.announceExplosion(this.world, this.entity, position, this.power, this.igniter, 0, 1.0))
		{
			return;
		}
