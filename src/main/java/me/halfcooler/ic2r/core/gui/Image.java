...
public class Image extends GuiElement<Image>
{
	...
	public static Image create(
		Ic2rGui<?> gui, int x, int y, int width, int height, ResourceLocation texture, int baseWidth, int baseHeight, int uS, int vS, int uE, int vE
	)
	{
	...
	public static Image create(
		Ic2rGui<?> gui, int x, int y, int width, int height, ResourceLocation texture, int baseWidth, int baseHeight, IOverlaySupplier overlay
	)
	{
