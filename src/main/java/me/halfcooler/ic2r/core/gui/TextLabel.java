...
public class TextLabel extends GuiElement<TextLabel>
{
	...
	public static TextLabel create(Ic2rGui<?> gui, int x, int y, String text, int color, boolean shadow)
	{
		return create(gui, x, y, TextProvider.of(text), color, shadow);
	}

	public static TextLabel create(Ic2rGui<?> gui, int x, int y, TextProvider.ITextProvider textProvider, int color, boolean shadow)
	{
		return create(gui, x, y, textProvider, color, shadow, false, false);
	}

	public static TextLabel create(Ic2rGui<?> gui, int x, int y, String text, int color, boolean shadow, boolean centerX, boolean centerY)
	{
		return create(gui, x, y, TextProvider.of(text), color, shadow, centerX, centerY);
	}

	public static TextLabel create(
		Ic2rGui<?> gui, int x, int y, TextProvider.ITextProvider textProvider, int color, boolean shadow, boolean centerX, boolean centerY
	)
	{
	...
	public static TextLabel create(
		Ic2rGui<?> gui, int x, int y, int width, int height, TextProvider.ITextProvider textProvider, int color, boolean shadow, boolean centerX, boolean centerY
	)
	{
	...
	private static int getWidth(Ic2rGui<?> gui, TextProvider.ITextProvider textProvider)
	{
