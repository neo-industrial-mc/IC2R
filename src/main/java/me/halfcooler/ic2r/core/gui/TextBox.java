...
public class TextBox extends GuiElement<TextBox>
{
	...
	public TextBox(Ic2rGui<?> gui, int x, int y, int width, int height)
	{
		this(gui, x, y, width, height, "");
	}

	public TextBox(Ic2rGui<?> gui, int x, int y, int width, int height, String text)
	{
		this(gui, x, y, width, height, text, true);
	}

	public TextBox(Ic2rGui<?> gui, int x, int y, int width, int height, boolean drawBackground)
	{
		this(gui, x, y, width, height, "", drawBackground);
	}

	public TextBox(Ic2rGui<?> gui, int x, int y, int width, int height, String text, boolean drawBackground)
	{
