...
public class Tfbp extends Item implements ITerraformingBP
{
	...
	{
		if (this == Ic2rItems.CULTIVATION_TFBP && world.dimension() == Level.END)
		{
			IC2R.grantAdvancement(player, "ic2r/build_generator/build_compressor/build_matter_gen/build_terraformer/terraform_end_cultivation");
		}
