...
class GridUpdater implements Runnable
{
	...
	public void run()
	{
		...
		{
			IC2R.log.error(LogCategory.EnergyNet, t, "Unhandled exception/error in GridUpdater.run(), force-clearing busy flag.");
			this.forceClear();
		}
	}
	...
	private void updateGrid()
	{
		...
		{
			IC2R.log.error(LogCategory.EnergyNet, t, "Unhandled exception/error in GridUpdater.updateGrid(), force-clearing busy flag.");
			this.forceClear();
		}
	}
	...
	private class GridCalcTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				IC2R.log.error(LogCategory.EnergyNet, t, "Unhandled exception/error in GridCalcTask.run() for grid %s.", this.grid);
			}
	...
	private class GridUpdateTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				IC2R.log.error(LogCategory.EnergyNet, t, "Unhandled exception/error in GridUpdateTask.run() for grid %s.", this.grid);
			}
