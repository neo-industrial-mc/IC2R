...
public class GuiEnergyOMatOpen extends Ic2rGui<ContainerEnergyOMatOpen>
{
	private static final ResourceLocation background = ResourceLocation.fromNamespaceAndPath("ic2r", "textures/gui/guienergyomatopen.png");
	...
	protected void drawForegroundLayer(GuiGraphics guiGraphics, int mouseX, int mouseY)
	{
		...
		this.drawString(guiGraphics, 100, 60, Component.translatable("ic2r.container.personalTrader.offer").getString(), 4210752);
