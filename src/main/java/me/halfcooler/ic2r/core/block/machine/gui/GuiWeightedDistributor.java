...
import me.halfcooler.ic2r.core.block.machine.tileentity.IWeightedDistributor;
...
public abstract class GuiWeightedDistributor<T extends ContainerBase<? extends IWeightedDistributor>> extends Ic2rGui<T>
{
	...
	public GuiWeightedDistributor(T container, Inventory playerInventory, Component title, int height)
	{
		...
		for (int y = 0; y < 5; y++)
		{
			...
			{
				case 0 -> TextProvider.ofTranslated("ic2r.WeightedDistributor.gui.highest");
				case 1 -> TextProvider.of("↑");
				case 2 -> TextProvider.ofTranslated("ic2r.WeightedDistributor.gui.priority");
				case 3 -> TextProvider.of("↓");
				case 4 -> TextProvider.ofTranslated("ic2r.WeightedDistributor.gui.lowest");
