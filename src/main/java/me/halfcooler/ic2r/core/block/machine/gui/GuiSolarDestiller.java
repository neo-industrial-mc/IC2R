...
public class GuiSolarDestiller extends Ic2rGui<ContainerSolarDistiller>
{
	...
	{
		return ResourceLocation.fromNamespaceAndPath("ic2r", "textures/gui/guisolardestiller.png");
	}
}
