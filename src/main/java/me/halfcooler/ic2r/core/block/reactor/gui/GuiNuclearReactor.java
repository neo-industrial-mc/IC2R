...
public class GuiNuclearReactor extends Ic2rGui<ContainerNuclearReactor>
{
	private static final ResourceLocation background = ResourceLocation.fromNamespaceAndPath("ic2r", "textures/gui/guinuclearreactor.png");
	private static final ResourceLocation backgroundFluid = ResourceLocation.fromNamespaceAndPath("ic2r", "textures/gui/guinuclearreactorfluid.png");
	...
	public GuiNuclearReactor(ContainerNuclearReactor container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(TextLabel.create(this, 107, 136, 200, 13, TextProvider.of(() -> GuiNuclearReactor.this.menu.base.isFluidCooled() ? Component.translatable("ic2r.NuclearReactor.gui.info.HUoutput", GuiNuclearReactor.this.menu.base.EmitHeat).getString() : Component.translatable("ic2r.NuclearReactor.gui.info.EUoutput", Math.round(GuiNuclearReactor.this.menu.base.getReactorEUEnergyOutput())).getString()), 5752026, false, 4, 0, false, true));
		this.addElement(new Area(this, 5, 160, 18, 18).withTooltip(() -> GuiNuclearReactor.this.menu.base.isFluidCooled() ? "ic2r.NuclearReactor.gui.mode.fluid" : "ic2r.NuclearReactor.gui.mode.electric"));
	}
