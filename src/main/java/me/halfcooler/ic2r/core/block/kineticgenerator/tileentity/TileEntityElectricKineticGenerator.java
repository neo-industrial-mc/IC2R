...
public class TileEntityElectricKineticGenerator extends TileEntityAbstractKineticGenerator implements IHasGui, ServerTicker
{
	...
	{
		super(Ic2rBlockEntities.ELECTRIC_KINETIC_GENERATOR, pos, state);
		this.kuPerEU = 4.0F * IC2RConfig.balance.energy.kineticGenerator.electric.get().floatValue();
		this.slotMotor = new InvSlotConsumableItemStack(this, "slotMotor", 10, new ItemStack(Ic2rItems.ELECTRIC_MOTOR));
