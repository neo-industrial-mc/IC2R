...
public class Ic2rCrops extends Crops
{
	...
	public static CropCard cropYellowFlower = new CropColorFlower(Ic2rCropType.dandelion, Ic2rBlocks.DANDELION_CROP.get(), new String[] { "Yellow", "Flower" }, DyeColor.YELLOW);
	public static CropCard cropRedFlower = new CropColorFlower(Ic2rCropType.poppy, Ic2rBlocks.POPPY_CROP.get(), new String[] { "Red", "Flower", "Rose" }, DyeColor.RED);
	public static CropCard cropBlackFlower = new CropColorFlower(Ic2rCropType.blackthorn, Ic2rBlocks.BLACKTHORN_CROP.get(), new String[] { "Black", "Flower", "Rose" }, DyeColor.BLACK);
	public static CropCard cropPurpleFlower = new CropColorFlower(Ic2rCropType.tulip, Ic2rBlocks.TULIP_CROP.get(), new String[] { "Purple", "Flower", "Tulip" }, DyeColor.PURPLE);
	public static CropCard cropBlueFlower = new CropColorFlower(Ic2rCropType.cyazint, Ic2rBlocks.CYAZINT_CROP.get(), new String[] { "Blue", "Flower" }, DyeColor.CYAN);
	...
	public static CropCard cropRedMushroom = new CropBaseMushroom(Ic2rCropType.redMushroom, Ic2rBlocks.RED_MUSHROOM_CROP.get(), new String[] { "Red", "Food", "Mushroom" }, new ItemStack(Blocks.RED_MUSHROOM));
	public static CropCard cropBrownMushroom = new CropBaseMushroom(Ic2rCropType.brownMushroom, Ic2rBlocks.BROWN_MUSHROOM_CROP.get(), new String[] { "Brown", "Food", "Mushroom" }, new ItemStack(Blocks.BROWN_MUSHROOM));
	...
	public static CropCard cropOakSapling = new CropBaseSapling(Ic2rCropType.oakSapling, Ic2rBlocks.OAK_SAPLING_CROP.get(), "seedling", new ItemStack(Blocks.OAK_LOG), new ItemStack(Blocks.OAK_SAPLING));
	public static CropCard cropSpruceSapling = new CropBaseSapling(Ic2rCropType.spruceSapling, Ic2rBlocks.SPRUCE_SAPLING_CROP.get(), "seedling", new ItemStack(Blocks.SPRUCE_LOG), new ItemStack(Blocks.SPRUCE_SAPLING));
	public static CropCard cropBirchSapling = new CropBaseSapling(Ic2rCropType.birchSapling, Ic2rBlocks.BIRCH_SAPLING_CROP.get(), "seedling", new ItemStack(Blocks.BIRCH_LOG), new ItemStack(Blocks.BIRCH_SAPLING));
	...
	public static CropCard cropPlumbiscus = new CropBaseMetalCommon(Ic2rCropType.plumbiscus, Ic2rBlocks.PLUMBISCUS_CROP.get(), new String[] { "Dense", "Leaves", "Metal" }, Arrays.asList(Ic2rBlockTags.LEAD_ORES, Ic2rBlockTags.LEAD_BLOCKS), new ItemStack(Ic2rItems.SMALL_LEAD_DUST));
	public static CropCard cropAurelia = new CropBaseMetalUncommon(Ic2rCropType.aurelia, Ic2rBlocks.AURELIA_CROP.get(), new String[] { "Gold", "Leaves", "Metal" }, Arrays.asList(BlockTags.GOLD_ORES, Ic2rBlockTags.GOLD_BLOCKS), new ItemStack(Ic2rItems.SMALL_GOLD_DUST));
	public static CropCard cropShining = new CropBaseMetalUncommon(Ic2rCropType.shining, Ic2rBlocks.SHINING_CROP.get(), new String[] { "Silver", "Leaves", "Metal" }, Arrays.asList(Ic2rBlockTags.SILVER_ORES, Ic2rBlockTags.SILVER_BLOCKS), new ItemStack(Ic2rItems.SMALL_SILVER_DUST));
