...
public class IC2RUuScanConfig
{
	...
	static
	{
		...
		values = b.defineListAllowEmpty("values", IC2RUuScanConfig::defaultValues, e -> e instanceof String);
		b.pop();
	...
	private static List<String> defaultValues()
	{
		...
		defaults.add("ic2r:rubber_wood 93036.19817400645");
		...
		defaults.add("ic2r:rubber_sapling 357182.2701030928");
		...
		defaults.add("ic2r:resin 3331411.5576923075");
